...
type Player = { id: string; name: string; points: number; wins: number; losses: number };
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={styles.scroll}>
        ...
        <View style={styles.card}>
          {standings.map((player, index) => (
            <View key={player.id} style={[styles.row, index === standings.length - 1 && styles.lastRow]}>
              ...
              <View style={styles.rowText}>
                ...
                <Text style={styles.rowRecord}>{player.wins}W · {player.losses}L</Text>
              </View>
