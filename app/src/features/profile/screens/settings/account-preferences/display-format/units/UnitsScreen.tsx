...
const UnitsInfoCard = () => (
  <View style={infoStyles.card}>
    ...
    <View style={infoStyles.infoRow}>
      <Ionicons name="information-circle-outline" size={18} color="#8E8E93" style={{ marginRight: 12 }} />
      <Text style={infoStyles.infoText}>Metric uses Celsius, kilograms, and centimetres. Imperial uses Fahrenheit, pounds, and feet.</Text>
    </View>
  </View>
);
