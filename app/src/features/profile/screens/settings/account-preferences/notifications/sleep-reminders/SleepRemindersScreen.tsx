            ...
            <View style={styles.labelGroup}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.subtitle}>
                  Get bedtime reminders 3 hours before your planned bedtime
                </Text>
              </View>
            </View>
            <Switch
        ...
        <View style={styles.infoCard}>
          ...
          <View style={styles.infoRow}>
            ...
            <Text style={styles.infoText}>
              You'll receive a reminder 3 hours before your planned bedtime to
              start winding down for a better night's sleep.
            </Text>
          </View>
        </View>
      </ScrollView>
