...
const ITEMS: NotifItem[] = [
  {
    title: "Supplements & Medication Reminders",
    subtitle: "Reminders to take supplements or medications",
    icon: "medical-outline",
    iconColor: "#FF9500",
    storageKey: "@notif_med_enabled",
    alertsKey: "@notif_med_alerts",
    defaultAlerts: ["30 minutes before"],
  },
  {
    title: "Medical Appointments",
    subtitle: "Reminders for upcoming appointments and health tests",
    icon: "calendar-outline",
    iconColor: "#AF52DE",
    storageKey: "@notif_appt_enabled",
    alertsKey: "@notif_appt_alerts",
    defaultAlerts: ["1 hour before"],
  },
  {
    title: "Monthly Health Summary",
    subtitle: "Monthly overview of your health and insights",
  ...
  },
  {
    ...
    subtitle: "Weekly recap of your health progress",
  ...
  },
  {
    ...
    subtitle: "Bedtime reminders to improve your sleep",
    icon: "bed-outline",
    iconColor: "#FF3B30",
    storageKey: "@notif_sleep_enabled",
    alertsKey: "@notif_sleep_alerts",
    defaultAlerts: ["30 minutes before bed"],
  },
];
        ...
        for (const item of ITEMS) {
          ...
          if (item.alertsKey) {
            ...
            if (al) {
              ...
              alertsMap[item.alertsKey] =
                Array.isArray(p) && p.length ? p : item.defaultAlerts || [];
            } else {
      ...
      >
        <View style={styles.card}>
          ...
          {ITEMS.map((item, index) => {
            ...
            const itemAlerts = item.alertsKey
              ? alerts[item.alertsKey] || item.defaultAlerts || []
              : [];
