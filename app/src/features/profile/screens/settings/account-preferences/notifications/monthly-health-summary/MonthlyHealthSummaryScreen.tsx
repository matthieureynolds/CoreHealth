...
const MonthlyHealthSummaryScreen: React.FC = () => {
  ...
  const [enabled, setEnabled] = useAsyncStorageToggle('@notif_monthly_enabled');
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header} pointerEvents="box-none">
        ...
        <Text style={styles.headerTitle} pointerEvents="none">Monthly Health Summary</Text>
        <View style={{ width: 24 }} />
      </View>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingTop: 110 }}>
        <View style={styles.card}>
          <View style={styles.toggleRow}>
            <View style={styles.labelGroup}>
              <Ionicons name="bar-chart-outline" size={24} color="#34C759" style={{ marginRight: 14 }} />
              <View style={{ flex: 1 }}>
                <Text style={styles.title}>Monthly Health Summary</Text>
                <Text style={styles.subtitle}>Receive a monthly overview of your health trends, insights, and progress</Text>
              </View>
            </View>
        ...
        <View style={styles.infoCard}>
          ...
          <View style={styles.infoRow}>
            ...
            <Text style={styles.infoText}>Sent on the 1st of each month with your previous month's health overview.</Text>
          </View>
        </View>
      </ScrollView>
    </View>
