...
const getDeviceIcon = (type: string) => {
  switch (type) {
    ...
    case 'oura_ring': return 'ellipse';
    case 'fitbit': return 'pulse';
    ...
    <View style={styles.deviceInfo}>
      <View style={styles.deviceImageContainer}>
        {device.image ? (
          ...
          <View style={[styles.deviceIcon, { backgroundColor: device.connected ? '#30D158' : '#E5E5EA' }]}>
            <Ionicons
      ...
      <View style={styles.deviceDetails}>
        ...
        <View style={styles.deviceStatus}>
          <Text style={[styles.deviceStatusText, { color: device.connected ? '#30D158' : '#8E8E93' }]}>
