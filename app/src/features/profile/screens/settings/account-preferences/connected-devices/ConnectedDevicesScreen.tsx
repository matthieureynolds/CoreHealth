...
const AVAILABLE_DEVICES: Device[] = [
  {
    id: "whoop",
    name: "WHOOP",
    logo: require("../../../../../../../assets/device-logos/WHOOP.webp"),
    color: "#000000",
  ...
  },
  {
    id: "apple-health",
    name: "Apple Health",
    logo: require("../../../../../../../assets/device-logos/Apple-Health.webp"),
    color: "#FF2D55",
  ...
  },
  {
    id: "dexcom",
    name: "Dexcom",
    logo: require("../../../../../../../assets/device-logos/DEXCOM.webp"),
    color: "#FF9500",
  ...
  },
  {
    id: "eight-sleep",
    name: "Eight Sleep",
    logo: require("../../../../../../../assets/device-logos/EIGHT-SLEEP.webp"),
    color: "#000000",
  ...
  },
  {
    id: "fitbit",
    name: "Fitbit",
    logo: require("../../../../../../../assets/device-logos/FITBIT.webp"),
    color: "#00B0B9",
  ...
  },
  {
    ...
    logo: require("../../../../../../../assets/device-logos/FREESTYLELIBRE-3.webp"),
    color: "#3AABF0",
  ...
  },
  {
    id: "garmin",
    name: "Garmin Connect",
    logo: require("../../../../../../../assets/device-logos/GARMIN.webp"),
    color: "#1A1A2E",
  ...
  },
  {
    id: "oura",
    name: "Oura Ring",
    logo: require("../../../../../../../assets/device-logos/OURA.webp"),
    color: "#1A2B5E",
  ...
  },
  {
    id: "withings",
    name: "Withings",
    logo: require("../../../../../../../assets/device-logos/WITHINGS.webp"),
    color: "#3AABF0",
  ...
  },
  {
    id: "zoe",
    name: "ZOE",
    logo: require("../../../../../../../assets/device-logos/ZOE.webp"),
    color: "#000000",
...
const ConnectedDevicesScreen: React.FC = () => {
  ...
  const [connectedDevices, setConnectedDevices] =
    useState<Device[]>(DEFAULT_CONNECTED);
    ...
    AVAILABLE_DEVICES.filter(
      (avail) =>
        !connectedDevices.some((conn) =>
          conn.name.toLowerCase().includes(
            avail.name
              .toLowerCase()
              .replace(/[®™]/g, "")
              .trim(),
  ...
  const connectWithOAuth = async (
    ...
    try {
      const { authUrl, redirectUri } = await DataService.getDeviceAuthUrl(
        user.id,
        oauthType,
      );
      ...
      if (result.type === "success") {
        ...
        if (code) {
          await DataService.exchangeDeviceCode(
            user.id,
            oauthType,
            code,
            redirectUri,
  ...
  const connectAppleHealth = async (device: Device) => {
    ...
    try {
      ...
      if (!granted) {
        Alert.alert(
          "Permission Denied",
          "Please allow CoreHealth to access Apple Health in Settings.",
        );
        return;
      }
      ...
      Alert.alert(
        "Connection Failed",
        e.message || "Could not connect Apple Health.",
      );
    } finally {
      setConnectingDevice(null);
    }
    ...
    Alert.alert(
      ...
      [
        { text: "Cancel", style: "cancel" },
        {
          ...
          style: "destructive",
          onPress: () => {
            const updated = sortAlpha(
              connectedDevices.filter((d) => d.id !== deviceId),
            );
            setConnectedDevices(updated);
            persist(updated);
          ...
          {connectedDevices.length > 0 ? (
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyStateSubtext}>
                Connect your first device to start syncing health data
              </Text>
            </View>
          )}
