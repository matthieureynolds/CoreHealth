...
const ConnectedDevicesScreen: React.FC = () => {
  ...
  const [connectedDevices, setConnectedDevices] = useState([
    {
      id: '2',
      name: 'Apple Health',
      logo: require('../../../../../../../assets/device-logos/Apple-Logo.png'),
      color: '#007AFF',
      status: 'Connected',
      lastSync: '1 hour ago',
    },
    {
      id: '1',
      name: 'WHOOP®',
      logo: require('../../../../../../../assets/device-logos/WHOOP.png'),
      color: '#4CD964',
      status: 'Connected',
  ...
  const availableDevices = [
    ...
    },
    {
      id: 'dexcom',
      name: 'Dexcom®',
      logo: require('../../../../../../../assets/device-logos/Dexcom.png'),
      color: '#FF9500',
    ...
    },
    {
      id: 'eight-sleep',
      name: 'Eight Sleep™',
      logo: require('../../../../../../../assets/device-logos/EightSleep.png'),
      color: '#34C759',
    ...
    },
    {
      id: 'fitbit',
      name: 'Fitbit®',
      logo: require('../../../../../../../assets/device-logos/Fitbit.png'),
      color: '#FF3B30',
    ...
    },
    {
      ...
      logo: require('../../../../../../../assets/device-logos/FreeStyle Libre.png'),
      color: '#007AFF',
    ...
    },
    {
      id: 'garmin',
      name: 'Garmin® Connect',
      logo: require('../../../../../../../assets/device-logos/Garmin.png'),
      color: '#FF9500',
    ...
    },
    {
      id: 'oura',
      name: 'Oura Ring™',
      logo: require('../../../../../../../assets/device-logos/OURA.png'),
      color: '#AF52DE',
    ...
    },
    {
      ...
      logo: require('../../../../../../../assets/device-logos/WithingsBPM2.png'),
      color: '#FF3B30',
    ...
    },
    {
      id: 'withings-scale',
      name: 'Withings® Body+',
      logo: require('../../../../../../../assets/device-logos/Withings Body+.jpg'),
      color: '#34C759',
    ...
    },
    {
      ...
      logo: require('../../../../../../../assets/device-logos/Withings ScanWatch.jpg'),
      color: '#AF52DE',
    ...
    },
    {
      ...
      logo: require('../../../../../../../assets/device-logos/WithingsThermo.jpg'),
      color: '#FF9500',
    ...
    },
    {
      ...
      logo: require('../../../../../../../assets/device-logos/Withings U-Scan.png'),
      color: '#007AFF',
    ...
    },
    {
      id: 'zoe',
      name: 'ZOE™',
      logo: require('../../../../../../../assets/device-logos/ZOE2.jpg'),
      color: '#FF3B30',
