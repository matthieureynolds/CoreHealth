  ...
  <View style={styles.section}>
    ...
    <View style={styles.missionContent}>
      <Text style={styles.missionText}>
        TOTO was created to empower individuals to take control of their health
        through intelligent tracking, personalized insights, and seamless data
        management. We believe that everyone deserves access to comprehensive
        health tools that respect privacy and put the user in control.
      </Text>
  ...
  <View style={styles.section}>
    ...
    <View style={styles.acknowledgments}>
      <Text style={styles.acknowledgeText}>
        Special thanks to the open-source community, our beta testers,
        healthcare professionals who provided guidance, and the amazing
        libraries that make TOTO possible:
      </Text>
