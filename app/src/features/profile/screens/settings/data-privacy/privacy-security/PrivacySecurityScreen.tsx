    ...
    >
      ...
      <View style={{ flex: 1 }}>
        <Text
          style={[
            styles.cardLabel,
            item.iconColor === "#FF3B30" && { color: "#FF3B30" },
          ]}
        >
          {item.title}
        </Text>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.toggleRow}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.cardSub}>
                  Protect your health data with fingerprint or face recognition
                </Text>
              </View>
              <Switch
                value={biometric}
                onValueChange={setBiometric}
                trackColor={{ false: "#3A3A3C", true: "#3AABF0" }}
                thumbColor="#FFFFFF"
              />
            </View>
            ...
            <View style={styles.toggleRow}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.cardSub}>
                  Manage location permissions for travel and health features
                </Text>
              </View>
              <Switch
            ...
            <View style={styles.toggleRow}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.cardSub}>
                  Sharing anonymised data for research and app improvement
                </Text>
              </View>
              <Switch
                value={dataConsent}
