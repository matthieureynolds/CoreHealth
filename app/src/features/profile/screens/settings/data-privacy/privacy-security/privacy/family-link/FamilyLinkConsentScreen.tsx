...
const FamilyLinkConsentScreen: React.FC = () => {
  ...
  const broadcast = async () => {
    try {
      ...
      Alert.alert(
        "Setup Required",
        "Select a recipient from your links to broadcast.",
      );
    } catch (e: any) {
      ...
      <View style={[styles.content, { paddingTop: SETTINGS_SCROLL_PT }]}>
        <View style={styles.card}>
          ...
          <Text style={styles.body}>
            Share only family-history facts as anonymous signals. No names, no
            metrics, no timestamps. You can revoke anytime.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          >
            {isLoading ? (
              ...
              <Text style={styles.primaryButtonText}>Broadcast Updates</Text>
            )}
          </TouchableOpacity>
        </View>
      </View>
