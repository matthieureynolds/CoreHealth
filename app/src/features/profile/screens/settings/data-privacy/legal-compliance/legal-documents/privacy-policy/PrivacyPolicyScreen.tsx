...
const PrivacyPolicyScreen: React.FC = () => (
  <LegalDocTemplate
    ...
    content={[
      ...
      "Address: TOTO Ltd, 123 Health Street, London, EC1A 1BB, United Kingdom",
      "",
      ...
      "",
      "TOTO maintains the following compliance certifications:",
      "• UK GDPR compliance",
