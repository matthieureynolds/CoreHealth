  ...
  const openMail = async (subject: string, body: string) => {
    ...
    if (supported) {
      ...
      Alert.alert(
        ...
        "Please email privacy@corehealth.com directly.",
      );
    }
  };
  ...
  const requestOptions = [
    {
      ...
      body:
        "I am submitting a Subject Access Request under UK GDPR / GDPR. Please provide a copy of all personal data you hold about me.\n\nAccount email: [your email]\nDate of request: " +
          ...
          {requestSent && (
            <View style={styles.successBanner}>
              ...
              <Text style={styles.successText}>
                Request sent! We will respond within 30 days.
              </Text>
            </View>
          )}
          ...
          <View style={styles.card}>
            ...
            {requestOptions.map((option, index) => (
              <TouchableOpacity
                ...
                style={[
                  styles.cardRow,
                  index === requestOptions.length - 1 && styles.lastRow,
                ]}
          ...
          <View style={styles.card}>
            ...
            <View style={styles.infoRow}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.infoText}>
                  Select the type of request above. An email will open
                  pre-filled with the required information.
                </Text>
              </View>
            </View>
            <View style={styles.infoRow}>
            ...
            <View style={styles.infoRow}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.infoText}>
                  We will respond to all data rights requests within 30 days as
                  required by UK GDPR.
                </Text>
              </View>
            </View>
