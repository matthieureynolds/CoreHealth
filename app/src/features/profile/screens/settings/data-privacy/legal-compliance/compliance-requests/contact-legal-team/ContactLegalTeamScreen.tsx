...
const ContactLegalTeamScreen: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      <SettingsHeader title="Contact Legal Team" />
          ...
          <View style={styles.card}>
            ...
            {contactOptions.map((option, index) => (
              <TouchableOpacity
                ...
                style={[
                  styles.cardRow,
                  index === contactOptions.length - 1 && styles.lastRow,
                ]}
          ...
          <View style={styles.card}>
            ...
            <View style={styles.infoRow}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.infoText}>
                  Responded to within 30 days as required by UK GDPR.
                </Text>
              </View>
            </View>
            <View style={styles.infoRow}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.infoText}>
                  Handled within 72 hours of discovery per regulatory
                  requirements.
                </Text>
              </View>
            </View>
