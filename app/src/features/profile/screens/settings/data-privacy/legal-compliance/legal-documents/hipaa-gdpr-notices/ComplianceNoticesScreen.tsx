...
const ComplianceNoticesScreen: React.FC = () => (
  <LegalDocTemplate
    ...
    content={[
      ...
      "HIPAA (US). For HIPAA‑covered data received from providers, TOTO acts as a Business Associate. Notice of privacy practices is available from your provider; TOTO safeguards PHI per HIPAA Security Rule.",
