  ...
  let html = `
    ...
    <head>
      ...
      <style>
        ...
        .doctor-info { background-color: #f0f8ff; border: 1px solid #007AFF; border-radius: 8px; padding: 15px; margin-bottom: 20px; }
        .doctor-title { font-size: 18px; font-weight: bold; color: #007AFF; margin-bottom: 5px; }
