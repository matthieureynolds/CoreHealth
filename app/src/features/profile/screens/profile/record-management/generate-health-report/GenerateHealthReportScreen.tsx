              ...
              try {
                if (Platform.OS === 'ios') {
                  if (await Sharing.isAvailableAsync()) {
                    await Sharing.shareAsync(uri, { mimeType: 'application/pdf', dialogTitle: 'Save Health Report', UTI: 'com.adobe.pdf' });
                  }
                } else {
            ...
            onPress: async () => {
              try {
                ...
                if (canOpen) {
                  ...
                  await Sharing.shareAsync(uri, { mimeType: 'application/pdf', dialogTitle: 'View Health Report', UTI: 'com.adobe.pdf' });
                } else {
