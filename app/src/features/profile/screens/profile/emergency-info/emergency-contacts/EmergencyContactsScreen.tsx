...
import EmergencyContactFormModal, {
  EmergencyContact,
...
const EmergencyContactsScreen: React.FC = () => {
  ...
  const [importedContactForm, setImportedContactForm] =
    useState<Partial<EmergencyContact> | null>(null);
    ...
    <View style={styles.container}>
      ...
      <EmergencyContactFormModal
        ...
        editingContact={
          ...
          (importedContactForm
            ? {
                ...(importedContactForm as EmergencyContact),
                id: "",
                relationship: "",
                isPrimary: false,
              }
