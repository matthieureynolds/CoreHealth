      ...
      <TouchableOpacity style={styles.overlay} activeOpacity={1} onPress={onClose}>
        <TouchableOpacity activeOpacity={1} onPress={() => {}} style={styles.sheet}>
          <View style={styles.header}>
            ...
            <Text style={styles.title}>{editingContact?.id ? 'Edit Contact' : 'Add Contact'}</Text>
          ...
          <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" style={styles.body}>
            ...
            <View style={styles.inputGroup}>
              <TextInput style={styles.groupInput} placeholder="Full Name *" placeholderTextColor="#8E8E93" value={name} onChangeText={setName} />
              <View style={styles.groupDivider} />
              <TextInput style={styles.groupInput} placeholder="Phone Number *" placeholderTextColor="#8E8E93" value={phone} onChangeText={setPhone} keyboardType="phone-pad" />
              <View style={styles.groupDivider} />
              <TextInput style={styles.groupInput} placeholder="Secondary Phone" placeholderTextColor="#555" value={secondaryPhone} onChangeText={setSecondaryPhone} keyboardType="phone-pad" />
              <View style={styles.groupDivider} />
              <TextInput style={styles.groupInput} placeholder="Email" placeholderTextColor="#555" value={email} onChangeText={setEmail} keyboardType="email-address" autoCapitalize="none" />
            </View>
            ...
            <Text style={styles.primaryHint}>Primary contact will be called first in emergencies</Text>

            {/* Notes */}
            <View style={[styles.inputGroup, { marginTop: 20 }]}>
              <TextInput style={[styles.groupInput, { height: 70, textAlignVertical: 'top', paddingTop: 14 }]} placeholder="Notes" placeholderTextColor="#555" value={notes} onChangeText={setNotes} multiline />
            </View>
          </ScrollView>
        </TouchableOpacity>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  sheet: { backgroundColor: '#1C1C1E', borderTopLeftRadius: 24, borderTopRightRadius: 24, maxHeight: '85%' },
  ...
  inputGroup: { backgroundColor: '#2C2C2E', borderRadius: 12, overflow: 'hidden' },
  groupInput: { paddingHorizontal: 16, paddingVertical: 13, fontSize: 16, color: '#FFFFFF' },
  ...
  primaryRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, paddingVertical: 13 },
