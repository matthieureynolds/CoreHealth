...
type ProfileDetailsScreenNavigationProp =
...
export function useProfileDetails() {
  ...
  const avatarOpacity = scrollY.interpolate({
    inputRange: [COLLAPSE_DISTANCE * 0.7, COLLAPSE_DISTANCE],
    outputRange: [1, 0],
    extrapolate: "clamp",
  });
  ...
  const headerBgOpacity = scrollY.interpolate({
    inputRange: [COLLAPSE_DISTANCE * 0.2, COLLAPSE_DISTANCE * 0.7],
    outputRange: [0, 1],
    extrapolate: "clamp",
  });
  ...
  const stickyHeaderOpacity = scrollY.interpolate({
    inputRange: [COLLAPSE_DISTANCE * 0.5, COLLAPSE_DISTANCE * 0.8],
    outputRange: [0, 1],
    extrapolate: "clamp",
  });
