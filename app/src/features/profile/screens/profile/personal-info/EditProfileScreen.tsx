...
const EditProfileScreen: React.FC = () => {
  ...
  const handlePickerSelect = (value: string) => {
    ...
    else if (activePicker === "ethnicity")
      setFormData({ ...formData, ethnicity: value });
    else if (activePicker === "bloodType")
      setFormData({ ...formData, bloodType: value as FormData["bloodType"] });
    setActivePicker(null);
  };

  const activePickerConfig =
    activePicker && activePicker !== "bloodType"
      ? pickerConfig[activePicker]
      : null;
      ...
      >
        <FormSection title="Personal Details">
          ...
          <PickerField
            label="Ethnicity"
            value={
              ethnicityOptions.find((opt) => opt.value === formData.ethnicity)
                ?.label || ""
            }
        ...
        <FormSection title="Physical Stats">
          ...
          <PickerField
            label="Blood Type"
            value={
              bloodTypeOptions.find((opt) => opt.value === formData.bloodType)
                ?.label || ""
            }
