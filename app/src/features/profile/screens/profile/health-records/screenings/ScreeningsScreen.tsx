...
const ScreeningsScreen: React.FC = () => {
  ...
  const config = useMemo(
    () => ({
      ...
      updateItems: (screenings: Screening[]) =>
        updateProfile({ ...profile, screenings }),
      ...
      >
        {screenings.length ? (
          screenings.map((screening) => {
            const resultColor =
              RESULT_COLORS[screening.result] ?? RESULT_DEFAULT_COLOR;
            return (
                  ...
                  <View style={styles.screeningInfo}>
                    ...
                    <View style={styles.resultBadge}>
                      ...
                      <Text style={[styles.resultText, { color: resultColor }]}>
                        {screening.result.charAt(0).toUpperCase() +
                          screening.result.slice(1)}
                      </Text>
                    </View>
                    ...
                    {screening.location && (
                      <Text style={styles.location}>{screening.location}</Text>
                    )}
                    {screening.notes && (
                      <Text style={styles.notes}>{screening.notes}</Text>
                    )}
          ...
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptySubtitle}>
              Add your screenings to keep track of your health checks
            </Text>
            <TouchableOpacity
