...
import {
  ...
  getLastNDays,
  type AdherenceData,
} from "@shared/utils/medicationAdherence";
...
const MedicationsScreen: React.FC = () => {
  ...
  const [expandedAdherenceMed, setExpandedAdherenceMed] = useState<
    string | null
  >(null);
  ...
  const adherenceMedicationNames = [
    ...TIMELINE_MEDICATION_NAMES,
    ...Object.keys(adherenceData),
              ...
              <View key={medName} style={styles.adherenceCard}>
                ...
                {isExpanded && (
                  <View style={styles.adherenceExpandedContent}>
                        ...
                        return (
                          <View key={dateKey} style={styles.adherenceDayWrap}>
                            <View
                              style={[
                                styles.adherenceDay,
                                isTook && styles.adherenceDayTook,
                                isSkipped && styles.adherenceDaySkipped,
                              ]}
                            >
                              {isTook && (
                                <Ionicons
                            ...
                            <Text style={styles.adherenceDayLabel}>
                              {dateKey.slice(-2)}
                            </Text>
                          </View>
                        );
                    ...
                    <Text style={styles.adherenceLegend}>
                      Last 14 days • green = took, orange = skipped
                    </Text>
                  </View>
                )}
              </View>
          ...
          {loading ? (
                        ...
                        <View style={styles.attachmentsRow}>
                          {medication.attachments.map((file) => (
                            <TouchableOpacity
                              ...
                              onPress={() =>
                                handleViewFile(file.uri, file.name, file.type)
                              }
                            >
                              <Ionicons
                                name={
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptySubtitle}>
                Add your medications to keep track of your treatment
              </Text>
              <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  medicationDetails: { fontSize: 14, color: "#3AABF0", marginBottom: 4 },
