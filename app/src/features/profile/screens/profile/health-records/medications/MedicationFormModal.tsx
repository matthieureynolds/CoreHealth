...
const MedicationFormModal: React.FC<MedicationFormModalProps> = ({ visible, editingMedication, onClose, onSave }) => {
  ...
  return (
    <FormModalShell visible={visible} title={editingMedication ? 'Edit Medication' : 'Add Medication'} onClose={onClose} onSave={handleSave}>
      <View style={s.group}>
        <SuggestionInput value={name} onChangeText={setName} placeholder="Medication Name *" suggestions={COMMON_MEDICATIONS} />
        <View style={s.divider} />
        <TextInput style={s.input} placeholder="Dosage (e.g. 500mg)" placeholderTextColor="#555" value={dosage} onChangeText={setDosage} />
        <View style={s.divider} />
        <TextInput style={s.input} placeholder="Frequency (e.g. Twice daily)" placeholderTextColor="#555" value={frequency} onChangeText={setFrequency} />
        <View style={s.divider} />
        <TextInput style={s.input} placeholder="Duration (e.g. 30 days)" placeholderTextColor="#555" value={duration} onChangeText={setDuration} />
      </View>
