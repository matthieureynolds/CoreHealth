...
const AppointmentDetailModal: React.FC<AppointmentDetailModalProps> = ({
  ...
  <Modal visible={!!appointment} transparent animationType="slide" presentationStyle="pageSheet">
    {appointment && (
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          ...
          <ScrollView style={styles.modalBody}>
            ...
            {appointment.doctor && (
              <Text style={styles.detailRow}><Text style={styles.detailLabel}>Doctor:</Text> {appointment.doctor}</Text>
            )}
            <Text style={styles.detailRow}><Text style={styles.detailLabel}>Date:</Text> {formatDate(appointment.date)}</Text>
            {appointment.location && (
              <Text style={styles.detailRow}><Text style={styles.detailLabel}>Location:</Text> {appointment.location}</Text>
            )}
            {appointment.notes && (
