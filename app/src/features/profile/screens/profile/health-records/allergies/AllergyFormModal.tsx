  ...
  useEffect(() => {
    if (visible) {
      if (editingAllergy) {
        ...
        setStartDate(
          editingAllergy.startDate ? new Date(editingAllergy.startDate) : null,
        );
        setEndDate(
          editingAllergy.endDate ? new Date(editingAllergy.endDate) : null,
        );
  ...
  return (
    ...
    >
      ...
      <ChipSelector
        ...
        onSelect={(opt) => {
          setStatus(opt);
          if (opt === "resolved" && !endDate) setEndDate(new Date());
        }}
      />
