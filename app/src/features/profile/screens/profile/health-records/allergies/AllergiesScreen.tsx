...
const allergyConfig = {
  loadFn: (userId: string) =>
    DataService.getAllergies(userId) as Promise<Allergy[]>,
  saveFn: async (userId: string, allergy: Allergy, isEdit: boolean) => {
    if (isEdit) {
      return (await DataService.updateAllergy(
        userId,
        allergy.id,
        allergy,
      )) as Allergy;
  ...
  deleteFn: (userId: string, id: string) =>
    DataService.deleteAllergy(userId, id),
  recordName: "Allergy",
          ...
          {loading ? (
                  ...
                  <View style={styles.allergyHeader}>
                    <View style={styles.allergyInfo}>
                      ...
                      <View style={styles.allergyTags}>
                        ...
                        >
                          <Text
                            style={[styles.tagText, { color: severityColor }]}
                          >
                      ...
                      <Text style={styles.allergyDate}>
                        Started: {formatDate(allergy.startDate)}
                      </Text>
                      {allergy.endDate && (
                        <Text style={styles.allergyDate}>
                          Ended: {formatDate(allergy.endDate)}
                        </Text>
                      )}
                      {allergy.notes && (
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptySubtitle}>
                Add your allergies to keep track of your sensitivities
              </Text>
              <TouchableOpacity
