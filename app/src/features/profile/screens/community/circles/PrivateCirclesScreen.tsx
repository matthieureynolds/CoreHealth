          ...
          {myCircles.length === 0 ? (
            ...
            myCircles.map((circle, index) => (
              <TouchableOpacity
                ...
                style={[
                  styles.row,
                  index === myCircles.length - 1 && styles.lastRow,
                ]}
                onPress={() =>
              ...
              >
                ...
                <View style={styles.rowText}>
                  ...
                  <Text style={styles.rowSubtitle}>
                    {circle.members} members · Private
                  </Text>
                </View>
                <TouchableOpacity
                  style={styles.joinedBtn}
                  onPress={() =>
                    setJoined((prev) => ({ ...prev, [circle.id]: false }))
                  }
                >
            ...
            <View style={styles.card}>
              {discoverCircles.map((circle, index) => (
                <View
                  ...
                  style={[
                    styles.row,
                    index === discoverCircles.length - 1 && styles.lastRow,
                  ]}
                >
                  <View
                    style={[
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() =>
                      setJoined((prev) => ({ ...prev, [circle.id]: true }))
                    }
                  >
