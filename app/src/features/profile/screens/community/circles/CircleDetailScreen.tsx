...
const MEMBERS = [
  ...
  .map((m) => ({
    ...m,
    overall: Math.round((m.recovery + m.biomarkers + m.lifestyle) / 3),
  }))
          ...
          <>
            <View style={styles.emptyCard}>
              ...
              <Text style={styles.emptySubtitle}>
                Share your invite code to bring people into your circle and
                start competing
              </Text>
            </View>
          </>
            ...
            <View style={styles.card}>
              ...
              {MEMBERS.map((m, i) => (
                <View
                  ...
                  style={[
                    styles.row,
                    i === MEMBERS.length - 1 && styles.lastRow,
                  ]}
                >
                  {/* Rank */}
        ...
        <View style={styles.shareCard}>
          <View style={styles.shareLeft}>
            ...
            <Text style={styles.shareSubtitle}>
              ...
              <Text style={styles.shareCode}>{inviteCode}</Text>
            </Text>
          </View>
          <TouchableOpacity
