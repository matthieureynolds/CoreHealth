      ...
      >
        {LEAGUE_CATEGORIES.map((cat) => (
          <TouchableOpacity
            ...
            style={[
              styles.filterChip,
              leagueCategory === cat && styles.filterChipGold,
            ]}
          ...
          >
            <Text
              style={[
                styles.filterText,
                leagueCategory === cat && styles.filterTextActive,
              ]}
            >
              {cat}
            </Text>
      ...
      <View style={styles.card}>
        {filteredLeagues.map((l, i) => (
          <TouchableOpacity
            ...
            style={[
              styles.row,
              i === filteredLeagues.length - 1 && styles.lastRow,
            ]}
            onPress={() =>
          ...
          >
            <View
              style={[
                ...
                {
                  backgroundColor: joinedLeagues[l.id]
                    ? "#FF9F0A30"
                    : "#FF9F0A15",
                },
              ]}
            ...
            >
              <Text
                style={[
                  styles.joinBtnText,
                  joinedLeagues[l.id] && styles.joinedBtnText,
                ]}
              >
