  ...
  return (
    <View style={styles.metricsSection}>
      <View style={styles.sectionGroupCard}>
        ...
        {HEALTH_METRIC_ROWS.map(
          ({ animKey, metricId, label, value, status, icon, scoreLabel }) => (
            <TreadmillCard
              key={animKey}
              scrollY={scrollY}
                ...
                >
                  <View
                    style={[
                      ...
                      {
                        backgroundColor: `${getMetricFixedIconColor(metricId, status)}20`,
                      },
                    ]}
                  >
                    <Ionicons
