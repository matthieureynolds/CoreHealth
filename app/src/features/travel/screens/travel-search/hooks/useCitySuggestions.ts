...
import { searchAllLocations, getPopularCities } from '../../../../../shared/services/travel/citySearchService';
 ...
 */
export function useCitySuggestions(query: string, setSuggestions: (v: string[]) => void) {
  useEffect(() => {
