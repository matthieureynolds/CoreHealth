    ...
    <View style={s.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingTop: 110, paddingBottom: 40 }}>
        <View style={styles.heroCard}>
          <View style={styles.heroIcon}><Ionicons name="cloud-outline" size={36} color="#5AC8FA" /></View>
        ...
        <View style={s.section}>
          ...
          {IMPACTS.map((i, idx) => <View key={idx} style={s.row}><Ionicons name="alert-circle-outline" size={16} color="#5AC8FA" /><Text style={s.rowText}>{i}</Text></View>)}
        </View>
        <View style={s.section}>
...
const styles = StyleSheet.create({
  heroCard: { backgroundColor: '#1C1C1E', borderRadius: 16, margin: 20, padding: 24, alignItems: 'center', borderWidth: 1, borderColor: '#5AC8FA30' },
  heroIcon: { width: 72, height: 72, borderRadius: 36, backgroundColor: '#5AC8FA20', alignItems: 'center', justifyContent: 'center', marginBottom: 16 },
