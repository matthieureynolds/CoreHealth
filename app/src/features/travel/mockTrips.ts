  ...
  // ── Paris → Tokyo (direct) — Air France AF274, CDG → Haneda ──
  {
    ...
    jetLagPlanner: {
      ...
      outboundPlan: {
        ...
        circadianPlan: [
          { day: -3, action: 'Start shifting earlier', time: 'Go to bed 1 hour earlier' },
          { day: -2, action: 'Continue adjustment', time: 'Go to bed 2 hours earlier' },
          { day: -1, action: 'Final adjustment', time: 'Go to bed 3 hours earlier' },
          { day: 0, action: 'Travel day', time: 'Sleep on the second half of the flight' },
          { day: 1, action: 'First day in Tokyo', time: 'Get morning sunlight, follow local meals' },
          { day: 2, action: 'Continue adaptation', time: 'Avoid naps after 15:00' },
      ...
      returnPlan: {
        ...
        timezoneAdjustment: '-7',
        circadianPlan: [
          { day: -3, action: 'Start shifting later', time: 'Go to bed 1 hour later' },
          { day: -2, action: 'Continue adjustment', time: 'Go to bed 2 hours later' },
          { day: -1, action: 'Final adjustment', time: 'Go to bed 3 hours later' },
          { day: 0, action: 'Return travel day', time: 'Stay awake until Paris bedtime' },
          { day: 1, action: 'First day back', time: 'Morning sunlight in Paris' },
    ...
    jetLagPlanner: {
      ...
      outboundPlan: {
        ...
        circadianPlan: [
          ...
          { day: -2, action: 'Continue adjustment', time: 'Go to bed 2 hours earlier' },
          { day: -1, action: 'Final adjustment', time: 'Go to bed 3 hours earlier' },
          { day: 0, action: 'Travel day', time: 'Layover in Helsinki — stay active, light meal' },
          { day: 1, action: 'First day in Hong Kong', time: 'Morning sunlight, follow local meals' },
          { day: 2, action: 'Continue adaptation', time: 'Avoid naps after 15:00' },
          { day: 3, action: 'Adjusted', time: 'Normal local schedule' },
        ],
      },
      returnPlan: {
        ...
        circadianPlan: [
          ...
          { day: -2, action: 'Continue adjustment', time: 'Go to bed 2 hours later' },
          { day: -1, action: 'Final adjustment', time: 'Go to bed 3 hours later' },
          { day: 0, action: 'Return travel day', time: 'Stay awake until London bedtime' },
          { day: 1, action: 'First day back', time: 'Morning sunlight in London' },
          { day: 2, action: 'Continue adaptation', time: 'Gradual adjustment' },
          { day: 3, action: 'Adjusted', time: 'Normal schedule' },
        ],
      },
