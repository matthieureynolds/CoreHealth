...
/**
 * Per-metric reference data for the environmental detail screen: band
 * definitions, labels and status colours.
 *
 * This is content, not behaviour — 580 lines of it — and it made the screen
 * that renders it unreadable. Splitting it also means adding a metric is an
 * edit to a data file rather than to a component.
 */
