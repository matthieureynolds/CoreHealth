  ...
  switch (status) {
    ...
    case "good":
      return [
        ...
        "Consider air purifiers if needed",
      ];
    case "moderate":
      return [
  ...
  switch (status) {
    ...
    case "good":
      return [
        ...
        "Most people comfortable outdoors",
        "Mild symptoms possible for very sensitive individuals",
      ];
    case "moderate":
      return [
    ...
    case "hazardous":
      return [
        "Severe allergic reactions likely",
...
const getWaterQualityExplanation = (status: string): string => {
  switch (status) {
    case "excellent":
      return "Water is completely safe to drink with no harmful contaminants. Contains beneficial minerals and meets all health standards.";
    case "good":
      return "Water is safe to drink with minimal contaminants well below harmful levels. Meets health standards and suitable for all daily uses.";
    case "moderate":
      return "Water is generally safe but may have taste, odor, or minor quality issues. Contaminants are present but below dangerous levels.";
    case "poor":
      return "Water has elevated contaminant levels that may pose health risks. Not recommended for drinking without treatment.";
    case "hazardous":
      return "Water is unsafe to drink with high contaminant levels that pose serious health risks. Do not consume tap water.";
    default:
  ...
  switch (status) {
    ...
    case "moderate":
      return [
        ...
        "Consider filtration for sensitive individuals",
      ];
    case "poor":
      return [
...
const getWaterQualityRecommendations = (status: string): string[] => {
  switch (status) {
    case "excellent":
      return [
        "Drink tap water freely",
        "Great for cooking and hydration",
    ...
    case "good":
      return [
        ...
        "Good for daily use",
        "Consider filtration for taste preferences",
      ];
    case "moderate":
      return [
        "Use water filters for drinking",
        "Boil water for cooking",
        "Consider bottled water for sensitive individuals",
      ];
    case "poor":
      return [
    ...
    case "hazardous":
      return [
        ...
        "Use bottled water for cooking and brushing teeth",
      ];
    default:
      return [
...
export function getMetricDetails(
  ...
  const details: Record<string, MetricDetails> = {
    ...
    water_quality: {
      ...
      normalRange:
        "Safe for consumption • Meets health standards • May have taste/odor issues",
      optimalRange:
  ...
  return (
    details[metricId] ?? {
      description:
        "This metric provides important information about your travel environment.",
