...
export const getBiomarkerDetails = (id: string): BiomarkerDetail => {
  const details: Record<string, BiomarkerDetail> = {
    ...
    // ── Liver ──
    alt: {
      description: 'ALT (alanine aminotransferase) is an enzyme found primarily in the liver. Elevated levels can indicate liver cell damage.',
      normalRange: '7–56 U/L',
      optimalRange: '10–30 U/L',
      whatItMeans: 'ALT is one of the most specific markers for liver health. Values within range suggest your liver cells are functioning well with no signs of inflammation or damage.',
      recommendations: [
    ...
    ast: {
      description: 'AST (aspartate aminotransferase) is an enzyme found in the liver, heart, and muscles. It helps assess liver function and can indicate tissue damage.',
      normalRange: '10–40 U/L',
      optimalRange: '10–25 U/L',
      whatItMeans: 'AST is less liver-specific than ALT — it also rises with muscle or heart damage. When both ALT and AST are normal, it strongly suggests healthy liver function.',
      recommendations: [
    ...
    ggt: {
      description: 'GGT (gamma-glutamyl transferase) is an enzyme involved in bile metabolism. It is a sensitive marker for liver and bile duct problems, and is particularly responsive to alcohol.',
      normalRange: '9–48 U/L',
      optimalRange: '9–30 U/L',
      whatItMeans: 'GGT is one of the earliest markers to rise with liver stress, especially alcohol-related. Normal levels suggest healthy bile flow and no significant liver inflammation.',
      recommendations: [
    ...
    alp: {
      description: 'ALP (alkaline phosphatase) is an enzyme found in the liver, bones, kidneys, and digestive system. It is important for assessing liver and bone health.',
      normalRange: '40–129 U/L',
      optimalRange: '50–90 U/L',
      whatItMeans: 'ALP is useful for detecting bile duct blockages and bone disorders. Normal levels suggest healthy liver drainage and bone metabolism.',
      recommendations: [
    ...
    total_bilirubin: {
      description: 'Bilirubin is a yellow pigment produced when the body breaks down red blood cells. The liver processes it for excretion. Elevated levels can cause jaundice.',
      normalRange: '0.1–1.2 mg/dL',
      optimalRange: '0.3–0.8 mg/dL',
      whatItMeans: 'Normal bilirubin indicates efficient red blood cell turnover and healthy liver clearance. Mildly elevated bilirubin (Gilbert\'s syndrome) is common and usually benign.',
      recommendations: [
    ...
    // ── Heart / Blood ──
    ldl_c: {
      description: 'LDL-C (low-density lipoprotein cholesterol) carries cholesterol to your arteries, where it can build up and form plaques.',
      normalRange: 'Less than 100 mg/dL',
      optimalRange: 'Less than 70 mg/dL',
      whatItMeans: 'High LDL-C is a major modifiable risk factor for atherosclerosis and cardiovascular disease. Lower is generally better.',
      recommendations: [
      ...
      riskFactors: ['High saturated fat diet', 'Lack of exercise', 'Obesity', 'Diabetes', 'Family history of cardiovascular disease'],
    },
    hdl_c: {
      description: 'HDL-C (high-density lipoprotein cholesterol) carries cholesterol away from arteries back to the liver. Often called "good" cholesterol.',
      normalRange: '>40 mg/dL (men), >50 mg/dL (women)',
      optimalRange: '>60 mg/dL',
      whatItMeans: 'Higher HDL is protective against heart disease. It acts as a scavenger, removing excess cholesterol from the bloodstream.',
      recommendations: [
      ...
      riskFactors: ['Sedentary lifestyle', 'Smoking', 'Poor diet high in trans fats', 'Obesity', 'Type 2 diabetes'],
    },
    triglycerides: {
      description: 'Triglycerides are the most common type of fat in the body. High levels increase the risk of heart disease, especially combined with high LDL or low HDL.',
      normalRange: '<150 mg/dL',
      optimalRange: '<100 mg/dL',
      whatItMeans: 'Elevated triglycerides are often driven by diet, excess alcohol, or metabolic conditions. They are an independent risk factor for cardiovascular disease.',
      recommendations: [
      ...
      riskFactors: ['High-sugar diet', 'Excess alcohol', 'Obesity', 'Uncontrolled diabetes', 'Hypothyroidism'],
    },
    apob: {
      description: 'ApoB (apolipoprotein B) is a protein on LDL and VLDL particles. It represents the total number of atherogenic particles in your blood — a more precise cardiovascular risk marker than LDL-C alone.',
      normalRange: '<1.2 g/L',
      optimalRange: '<0.8 g/L',
      whatItMeans: 'ApoB counts the actual number of harmful cholesterol-carrying particles. Many longevity-focused physicians consider it the single best lipid marker for cardiovascular risk.',
      recommendations: [
      ...
      riskFactors: ['Familial hypercholesterolaemia', 'High saturated fat intake', 'Insulin resistance', 'Obesity', 'Sedentary lifestyle'],
    },
    hs_crp: {
      description: 'hs-CRP (high-sensitivity C-reactive protein) is a marker of systemic inflammation. Chronic low-grade inflammation is linked to cardiovascular disease and metabolic dysfunction.',
      normalRange: '<3.0 mg/L',
      optimalRange: '<1.0 mg/L',
      whatItMeans: 'Low hs-CRP suggests minimal systemic inflammation. Elevated levels may indicate chronic inflammation, infection, or increased cardiovascular risk even when cholesterol is normal.',
      recommendations: [
      ...
      riskFactors: ['Obesity', 'Chronic stress', 'Poor sleep', 'Smoking', 'Autoimmune conditions or chronic infections'],
    },
    homocysteine: {
      description: 'Homocysteine is an amino acid in the blood. High levels are associated with increased risk of cardiovascular disease, cognitive decline, and blood clots.',
      normalRange: '4–15 μmol/L',
      optimalRange: '5–10 μmol/L',
      whatItMeans: 'Elevated homocysteine can damage blood vessel walls and promote clotting. It is often driven by B-vitamin deficiencies (B6, B12, folate).',
      recommendations: [
      ...
      riskFactors: ['B12 or folate deficiency', 'MTHFR gene variants', 'Kidney disease', 'Hypothyroidism', 'Excessive coffee or alcohol'],
    },
    red_blood_cells: {
      description: 'Red blood cells (RBCs) carry oxygen from the lungs to every tissue in the body and return carbon dioxide for exhalation.',
      normalRange: '4.5–5.5 M/μL (men), 4.0–5.0 M/μL (women)',
      optimalRange: 'Mid-range for sex-specific normals',
      whatItMeans: 'Normal RBC count means your body is producing enough cells to meet oxygen demands. Low counts suggest anaemia; high counts may indicate dehydration or polycythaemia.',
      recommendations: [
      ...
      riskFactors: ['Iron deficiency', 'B12/folate deficiency', 'Chronic kidney disease', 'Bone marrow disorders', 'Dehydration (false elevation)'],
    },
    white_blood_cells: {
      description: 'White blood cells (WBCs) are part of your immune system. They fight infections, respond to inflammation, and patrol for abnormal cells.',
      normalRange: '4.0–11.0 K/μL',
      optimalRange: '4.5–7.5 K/μL',
      whatItMeans: 'Normal WBC count indicates a balanced immune system with no active infection or inflammatory process. Persistently elevated WBCs can signal chronic inflammation.',
      recommendations: [
      ...
      riskFactors: ['Active infection', 'Chronic inflammation or autoimmune disease', 'Severe stress', 'Smoking', 'Bone marrow disorders (rare)'],
    },
    // ── Kidneys ──
    urea: {
      description: 'Urea (blood urea nitrogen) is a waste product from protein metabolism, filtered by the kidneys. It reflects kidney function and protein intake.',
      normalRange: '7–20 mg/dL',
      optimalRange: '10–16 mg/dL',
      whatItMeans: 'Normal urea suggests your kidneys are effectively filtering waste. Elevated levels can indicate kidney dysfunction, dehydration, or very high protein intake.',
      recommendations: [
      ...
      riskFactors: ['Dehydration', 'High-protein diet', 'Kidney disease', 'Heart failure', 'GI bleeding'],
    },
    sodium: {
      description: 'Sodium is a key electrolyte that regulates fluid balance, nerve function, and muscle contractions.',
      normalRange: '136–145 mmol/L',
      optimalRange: '138–142 mmol/L',
      whatItMeans: 'Normal sodium indicates good fluid and electrolyte balance. Abnormal levels can affect brain function, blood pressure, and muscle performance.',
      recommendations: [
      ...
      riskFactors: ['Excessive water intake (dilutional hyponatraemia)', 'Diuretic use', 'Kidney disease', 'Heart failure', 'Severe dehydration'],
    },
    potassium: {
      description: 'Potassium is an essential electrolyte for heart rhythm, muscle contraction, and nerve signalling.',
      normalRange: '3.5–5.1 mmol/L',
      optimalRange: '3.8–4.6 mmol/L',
      whatItMeans: 'Normal potassium is critical for heart function. Both high and low potassium can cause dangerous cardiac arrhythmias.',
      recommendations: [
      ...
      riskFactors: ['Kidney disease', 'Certain medications (ACE inhibitors, diuretics)', 'Excessive sweating or vomiting', 'Adrenal insufficiency', 'Metabolic acidosis'],
    },
    magnesium: {
      description: 'Magnesium is involved in over 300 enzymatic reactions including energy production, muscle relaxation, and nervous system regulation.',
      normalRange: '1.7–2.2 mg/dL',
      optimalRange: '2.0–2.2 mg/dL',
      whatItMeans: 'Normal magnesium supports healthy sleep, muscle function, and stress response. Deficiency is very common and often underdiagnosed.',
      recommendations: [
      ...
      riskFactors: ['Poor dietary intake', 'Alcohol use', 'Proton pump inhibitor (PPI) use', 'Diabetes', 'Chronic stress'],
    },
    // ── Gut / Absorption ──
    vitamin_d: {
      description: 'Vitamin D is essential for bone health, immune function, and mood regulation. It is produced in the skin with sunlight and obtained from food.',
      normalRange: '30–100 ng/mL',
      optimalRange: '40–60 ng/mL',
      whatItMeans: 'Adequate vitamin D supports strong bones, a healthy immune system, and reduced inflammation. Deficiency is extremely common, especially in northern latitudes.',
      recommendations: [
      ...
      riskFactors: ['Limited sun exposure', 'Dark skin pigmentation', 'Obesity (vitamin D is sequestered in fat)', 'Malabsorption conditions', 'Age over 65'],
    },
    vitamin_b12: {
      description: 'Vitamin B12 is essential for nerve function, red blood cell formation, and DNA synthesis. Deficiency can cause anaemia and neurological symptoms.',
      normalRange: '200–900 pg/mL',
      optimalRange: '400–700 pg/mL',
      whatItMeans: 'Adequate B12 supports energy, cognitive function, and healthy nerves. Deficiency develops slowly and can cause irreversible nerve damage if untreated.',
      recommendations: [
      ...
      riskFactors: ['Vegan/vegetarian diet without supplementation', 'Pernicious anaemia', 'Metformin or PPI use', 'Age over 60 (reduced absorption)', 'Gastric surgery or Crohn\'s disease'],
    },
    folate: {
      description: 'Folate (vitamin B9) is critical for DNA synthesis, cell division, and red blood cell formation. It is especially important during pregnancy.',
      normalRange: '3–17 ng/mL',
      optimalRange: '8–15 ng/mL',
      whatItMeans: 'Adequate folate supports healthy cell turnover and works synergistically with B12. Low folate can cause megaloblastic anaemia and elevated homocysteine.',
      recommendations: [
      ...
      riskFactors: ['Poor vegetable intake', 'Alcohol use', 'MTHFR gene variants', 'Pregnancy (increased demand)', 'Malabsorption conditions'],
    },
    calcium: {
      description: 'Calcium is the most abundant mineral in the body, essential for bones, teeth, muscle contraction, and nerve function.',
      normalRange: '8.5–10.5 mg/dL',
      optimalRange: '9.0–10.0 mg/dL',
      whatItMeans: 'Normal calcium reflects healthy parathyroid function and bone metabolism. The body tightly regulates blood calcium, so abnormalities can signal parathyroid or kidney issues.',
      recommendations: [
      ...
      riskFactors: ['Vitamin D deficiency', 'Parathyroid disorders', 'Kidney disease', 'Excessive dairy or supplement intake', 'Certain cancers'],
    },
    ferritin: {
      description: 'Ferritin is the body\'s iron storage protein. It reflects total iron reserves and is the first marker to drop in iron deficiency.',
      normalRange: '20–250 ng/mL',
      optimalRange: '50–150 ng/mL',
      whatItMeans: 'Optimal ferritin means you have healthy iron reserves for energy, oxygen transport, and immune function. Low ferritin causes fatigue even before anaemia develops.',
      recommendations: [
      ...
      riskFactors: ['Menstruation (women of reproductive age)', 'Vegetarian/vegan diet', 'GI blood loss', 'Chronic inflammation (falsely elevates ferritin)', 'Coeliac disease'],
    },
    transferrin_saturation: {
      description: 'Transferrin saturation measures the percentage of the iron-transport protein transferrin that is loaded with iron. It reflects how much iron is actively circulating.',
      normalRange: '20–50%',
      optimalRange: '25–35%',
      whatItMeans: 'Normal transferrin saturation confirms iron is being transported effectively. Low values suggest iron deficiency; very high values may indicate iron overload (haemochromatosis).',
      recommendations: [
      ...
      riskFactors: ['Iron deficiency anaemia', 'Hereditary haemochromatosis', 'Chronic disease', 'Liver disease', 'Frequent blood transfusions'],
    },
    // ── Thyroid ──
    tsh: {
      description: 'TSH (thyroid-stimulating hormone) is produced by the pituitary gland to regulate thyroid function. It is the primary screening test for thyroid disorders.',
      normalRange: '0.4–4.0 mIU/L',
      optimalRange: '1.0–2.5 mIU/L',
      whatItMeans: 'Normal TSH suggests your thyroid is producing the right amount of hormones. High TSH indicates hypothyroidism (underactive); low TSH indicates hyperthyroidism (overactive).',
      recommendations: [
      ...
      riskFactors: ['Family history of thyroid disease', 'Autoimmune conditions (Hashimoto\'s, Graves\')', 'Iodine deficiency or excess', 'Previous radiation to head/neck', 'Women over 60'],
    },
    free_t3: {
      description: 'Free T3 (triiodothyronine) is the most active thyroid hormone. It drives metabolism, energy, and body temperature at the cellular level.',
      normalRange: '2.3–4.2 pg/mL',
      optimalRange: '3.0–3.8 pg/mL',
      whatItMeans: 'Optimal Free T3 means your body is effectively converting T4 to its active form. Low T3 with normal TSH can explain fatigue and low metabolism despite "normal" thyroid tests.',
      recommendations: [
      ...
      riskFactors: ['Chronic stress', 'Selenium deficiency', 'Extreme dieting', 'Chronic illness (sick euthyroid syndrome)', 'Liver disease (impairs conversion)'],
    },
    free_t4: {
      description: 'Free T4 (thyroxine) is the main hormone produced by the thyroid gland. It circulates to tissues where it is converted to active T3.',
      normalRange: '0.8–1.8 ng/dL',
      optimalRange: '1.0–1.5 ng/dL',
      whatItMeans: 'Normal Free T4 confirms your thyroid is producing adequate hormone. Combined with TSH, it gives a complete picture of thyroid health.',
      recommendations: [
      ...
      riskFactors: ['Autoimmune thyroid disease', 'Iodine deficiency', 'Pituitary disorders', 'Pregnancy', 'Certain medications (lithium, amiodarone)'],
    },
    // ── Metabolic / Pancreas ──
    fasting_glucose: {
      description: 'Fasting glucose measures blood sugar after at least 8 hours without food. It is a key marker for diabetes screening and metabolic health.',
      normalRange: '70–99 mg/dL',
      optimalRange: '75–88 mg/dL',
      whatItMeans: 'Optimal fasting glucose reflects good insulin sensitivity and healthy blood sugar regulation. Consistently elevated levels suggest progressing insulin resistance.',
      recommendations: [
        'Limit refined carbohydrates and sugary foods',
      ...
      riskFactors: ['Obesity', 'Family history of diabetes', 'Sedentary lifestyle', 'Poor sleep', 'High-carbohydrate diet'],
    },
    hba1c: {
      description: 'HbA1c (glycated haemoglobin) reflects your average blood sugar over the past 2–3 months. It is the gold standard for assessing long-term glucose control.',
      normalRange: '<5.7%',
      optimalRange: '4.8–5.3%',
      whatItMeans: 'A low HbA1c indicates excellent long-term blood sugar control. It is more reliable than fasting glucose because it is not affected by a single day\'s eating.',
      recommendations: [
      ...
      riskFactors: ['Insulin resistance', 'Obesity', 'Sedentary lifestyle', 'High-sugar/refined-carb diet', 'Family history of diabetes'],
    },
    fasting_insulin: {
      description: 'Fasting insulin measures how much insulin your pancreas produces at rest. It is one of the earliest markers of insulin resistance — often abnormal years before glucose rises.',
      normalRange: '2–20 mIU/L',
      optimalRange: '3–8 mIU/L',
      whatItMeans: 'Optimal fasting insulin suggests your pancreas is not overworking to keep blood sugar normal. Elevated insulin with normal glucose is an early warning of metabolic dysfunction.',
      recommendations: [
      ...
      riskFactors: ['Obesity (especially visceral fat)', 'High-sugar diet', 'Sedentary lifestyle', 'PCOS', 'Family history of type 2 diabetes'],
    },
    homa_ir: {
      description: 'HOMA-IR (Homeostatic Model Assessment of Insulin Resistance) is calculated from fasting glucose and insulin. It quantifies how resistant your cells are to insulin.',
      normalRange: '<2.0',
      optimalRange: '<1.5',
      whatItMeans: 'A low HOMA-IR score means your cells respond efficiently to insulin. Higher values indicate the body needs more insulin to manage blood sugar — a precursor to type 2 diabetes.',
      recommendations: [
      ...
      riskFactors: ['Visceral obesity', 'Sedentary lifestyle', 'High-carb/high-sugar diet', 'Chronic stress and poor sleep', 'Genetic predisposition'],
    },
    // ── Brain / Neuro ──
    cortisol: {
      description: 'Cortisol is the body\'s primary stress hormone, produced by the adrenal glands. It follows a diurnal rhythm — highest in the morning and lowest at night.',
      normalRange: '6–18.4 μg/dL (morning)',
      optimalRange: '10–15 μg/dL (morning)',
      whatItMeans: 'Normal cortisol indicates a healthy stress response and adrenal function. Chronically elevated cortisol disrupts sleep, immunity, metabolism, and cognitive function.',
      recommendations: [
      ...
      riskFactors: ['Chronic psychological stress', 'Sleep deprivation', 'Overtraining', 'Cushing\'s syndrome (rare)', 'Adrenal insufficiency (low cortisol)'],
    },
    // ── Lungs ──
    spo2: {
      description: 'SpO₂ (peripheral oxygen saturation) measures the percentage of haemoglobin molecules carrying oxygen. It is typically measured via pulse oximetry.',
      normalRange: '95–100%',
      optimalRange: '97–99%',
      whatItMeans: 'Normal SpO₂ confirms your lungs are efficiently oxygenating your blood. Values below 95% may indicate respiratory issues.',
      recommendations: [
      ...
      riskFactors: ['Chronic lung disease (COPD, asthma)', 'Smoking', 'High altitude', 'Sleep apnoea', 'Severe anaemia'],
    },
    fev1: {
      description: 'FEV1 (forced expiratory volume in 1 second) measures how much air you can forcefully exhale in one second. It is a key marker of lung function.',
      normalRange: '>80% of predicted value',
      optimalRange: '>90% of predicted',
      whatItMeans: 'Normal FEV1 indicates healthy airways without obstruction. It is the primary measure used to diagnose and grade obstructive lung diseases.',
      recommendations: [
      ...
      riskFactors: ['Smoking history', 'Asthma', 'Occupational dust/chemical exposure', 'Recurrent respiratory infections', 'Alpha-1 antitrypsin deficiency'],
    },
    fvc: {
      description: 'FVC (forced vital capacity) is the total volume of air you can forcefully exhale after a maximum inhalation. It assesses overall lung capacity.',
      normalRange: '>80% of predicted value',
      optimalRange: '>90% of predicted',
      whatItMeans: 'Normal FVC means your lungs can hold and expel the expected volume of air. Reduced FVC may indicate restrictive lung disease or poor respiratory muscle strength.',
      recommendations: [
      ...
      riskFactors: ['Obesity', 'Pulmonary fibrosis', 'Neuromuscular conditions', 'Chest wall deformity', 'Smoking'],
    },
  };
