...
const getHistoricalData = (id: string): { date: string; value: number }[] => {
  const map: Record<string, { date: string; value: number }[]> = {
    total_cholesterol: [
      { date: "Aug 24", value: 215 },
      { date: "Nov 24", value: 205 },
      { date: "Feb 25", value: 198 },
      { date: "May 25", value: 195 },
      { date: "Nov 25", value: 188 },
      { date: "May 26", value: 180 },
    ],
    ldl_cholesterol: [
      { date: "Aug 24", value: 125 },
      { date: "Nov 24", value: 118 },
      { date: "Feb 25", value: 110 },
      { date: "May 25", value: 105 },
      { date: "Nov 25", value: 100 },
      { date: "May 26", value: 95 },
    ],
    glucose: [
      { date: "Aug 24", value: 92 },
      { date: "Nov 24", value: 90 },
      { date: "Feb 25", value: 87 },
      { date: "May 25", value: 89 },
      { date: "Nov 25", value: 86 },
      { date: "May 26", value: 88 },
    ],
    creatinine: [
      { date: "Aug 24", value: 0.8 },
      { date: "Nov 24", value: 0.82 },
      { date: "Feb 25", value: 0.85 },
      { date: "May 25", value: 0.87 },
      { date: "Nov 25", value: 0.88 },
      { date: "May 26", value: 0.9 },
    ],
    hemoglobin: [
      { date: "Aug 24", value: 13.8 },
      { date: "Nov 24", value: 14.0 },
      { date: "Feb 25", value: 14.1 },
      { date: "May 25", value: 14.3 },
      { date: "Nov 25", value: 14.1 },
      { date: "May 26", value: 14.2 },
    ],
    platelets: [
      { date: "Aug 24", value: 240 },
      { date: "Nov 24", value: 235 },
      { date: "Feb 25", value: 228 },
      { date: "May 25", value: 230 },
      { date: "Nov 25", value: 225 },
      { date: "May 26", value: 220 },
    ],
    // Liver
    alt: [
      { date: "Aug 24", value: 32 },
      { date: "Nov 24", value: 30 },
      { date: "Feb 25", value: 29 },
      { date: "May 25", value: 27 },
      { date: "Nov 25", value: 28 },
      { date: "May 26", value: 28 },
    ],
    ast: [
      { date: "Aug 24", value: 25 },
      { date: "Nov 24", value: 24 },
      { date: "Feb 25", value: 23 },
      { date: "May 25", value: 22 },
      { date: "Nov 25", value: 23 },
      { date: "May 26", value: 22 },
    ],
    ggt: [
      { date: "Aug 24", value: 30 },
      { date: "Nov 24", value: 28 },
      { date: "Feb 25", value: 27 },
      { date: "May 25", value: 26 },
      { date: "Nov 25", value: 25 },
      { date: "May 26", value: 25 },
    ],
    alp: [
      { date: "Aug 24", value: 82 },
      { date: "Nov 24", value: 80 },
      { date: "Feb 25", value: 79 },
      { date: "May 25", value: 78 },
      { date: "Nov 25", value: 77 },
      { date: "May 26", value: 78 },
    ],
    total_bilirubin: [
      { date: "Aug 24", value: 0.9 },
      { date: "Nov 24", value: 0.85 },
      { date: "Feb 25", value: 0.82 },
      { date: "May 25", value: 0.8 },
      { date: "Nov 25", value: 0.78 },
      { date: "May 26", value: 0.8 },
    ],
    // Heart extras
    hdl_c: [
      { date: "Aug 24", value: 52 },
      { date: "Nov 24", value: 54 },
      { date: "Feb 25", value: 55 },
      { date: "May 25", value: 56 },
      { date: "Nov 25", value: 57 },
      { date: "May 26", value: 58 },
    ],
    ldl_c: [
      { date: "Aug 24", value: 110 },
      { date: "Nov 24", value: 105 },
      { date: "Feb 25", value: 100 },
      { date: "May 25", value: 98 },
      { date: "Nov 25", value: 96 },
      { date: "May 26", value: 95 },
    ],
    triglycerides: [
      { date: "Aug 24", value: 140 },
      { date: "Nov 24", value: 135 },
      { date: "Feb 25", value: 130 },
      { date: "May 25", value: 125 },
      { date: "Nov 25", value: 122 },
      { date: "May 26", value: 120 },
    ],
    apob: [
      { date: "Aug 24", value: 0.95 },
      { date: "Nov 24", value: 0.92 },
      { date: "Feb 25", value: 0.9 },
      { date: "May 25", value: 0.88 },
      { date: "Nov 25", value: 0.86 },
      { date: "May 26", value: 0.85 },
    ],
    hs_crp: [
      { date: "Aug 24", value: 1.2 },
      { date: "Nov 24", value: 1.0 },
      { date: "Feb 25", value: 0.9 },
      { date: "May 25", value: 0.85 },
      { date: "Nov 25", value: 0.82 },
      { date: "May 26", value: 0.8 },
    ],
    homocysteine: [
      { date: "Aug 24", value: 10.2 },
      { date: "Nov 24", value: 9.5 },
      { date: "Feb 25", value: 9.0 },
      { date: "May 25", value: 8.8 },
      { date: "Nov 25", value: 8.6 },
      { date: "May 26", value: 8.5 },
    ],
    red_blood_cells: [
      { date: "Aug 24", value: 4.8 },
      { date: "Nov 24", value: 4.85 },
      { date: "Feb 25", value: 4.9 },
      { date: "May 25", value: 4.88 },
      { date: "Nov 25", value: 4.9 },
      { date: "May 26", value: 4.9 },
    ],
    white_blood_cells: [
      { date: "Aug 24", value: 6.5 },
      { date: "Nov 24", value: 6.3 },
      { date: "Feb 25", value: 6.1 },
      { date: "May 25", value: 6.2 },
      { date: "Nov 25", value: 6.0 },
      { date: "May 26", value: 6.2 },
    ],
    // Kidneys
    urea: [
      { date: "Aug 24", value: 16 },
      { date: "Nov 24", value: 15.5 },
      { date: "Feb 25", value: 15 },
      { date: "May 25", value: 14.8 },
      { date: "Nov 25", value: 15 },
      { date: "May 26", value: 15 },
    ],
    sodium: [
      { date: "Aug 24", value: 141 },
      { date: "Nov 24", value: 140 },
      { date: "Feb 25", value: 139 },
      { date: "May 25", value: 140 },
      { date: "Nov 25", value: 140 },
      { date: "May 26", value: 140 },
    ],
    potassium: [
      { date: "Aug 24", value: 4.3 },
      { date: "Nov 24", value: 4.2 },
      { date: "Feb 25", value: 4.1 },
      { date: "May 25", value: 4.2 },
      { date: "Nov 25", value: 4.2 },
      { date: "May 26", value: 4.2 },
    ],
    magnesium: [
      { date: "Aug 24", value: 2.0 },
      { date: "Nov 24", value: 2.05 },
      { date: "Feb 25", value: 2.1 },
      { date: "May 25", value: 2.08 },
      { date: "Nov 25", value: 2.1 },
      { date: "May 26", value: 2.1 },
    ],
    // Gut / Absorption
    vitamin_d: [
      { date: "Aug 24", value: 35 },
      { date: "Nov 24", value: 38 },
      { date: "Feb 25", value: 30 },
      { date: "May 25", value: 36 },
      { date: "Nov 25", value: 40 },
      { date: "May 26", value: 42 },
    ],
    vitamin_b12: [
      { date: "Aug 24", value: 420 },
      { date: "Nov 24", value: 430 },
      { date: "Feb 25", value: 440 },
      { date: "May 25", value: 445 },
      { date: "Nov 25", value: 448 },
      { date: "May 26", value: 450 },
    ],
    folate: [
      { date: "Aug 24", value: 10 },
      { date: "Nov 24", value: 10.5 },
      { date: "Feb 25", value: 11 },
      { date: "May 25", value: 11.5 },
      { date: "Nov 25", value: 11.8 },
      { date: "May 26", value: 12 },
    ],
    calcium: [
      { date: "Aug 24", value: 9.4 },
      { date: "Nov 24", value: 9.45 },
      { date: "Feb 25", value: 9.5 },
      { date: "May 25", value: 9.48 },
      { date: "Nov 25", value: 9.5 },
      { date: "May 26", value: 9.5 },
    ],
    ferritin: [
      { date: "Aug 24", value: 75 },
      { date: "Nov 24", value: 78 },
      { date: "Feb 25", value: 80 },
      { date: "May 25", value: 82 },
      { date: "Nov 25", value: 84 },
      { date: "May 26", value: 85 },
    ],
    transferrin_saturation: [
      { date: "Aug 24", value: 28 },
      { date: "Nov 24", value: 29 },
      { date: "Feb 25", value: 29 },
      { date: "May 25", value: 30 },
      { date: "Nov 25", value: 30 },
      { date: "May 26", value: 30 },
    ],
    // Thyroid
    tsh: [
      { date: "Aug 24", value: 2.3 },
      { date: "Nov 24", value: 2.2 },
      { date: "Feb 25", value: 2.15 },
      { date: "May 25", value: 2.1 },
      { date: "Nov 25", value: 2.1 },
      { date: "May 26", value: 2.1 },
    ],
    free_t3: [
      { date: "Aug 24", value: 3.0 },
      { date: "Nov 24", value: 3.1 },
      { date: "Feb 25", value: 3.15 },
      { date: "May 25", value: 3.2 },
      { date: "Nov 25", value: 3.18 },
      { date: "May 26", value: 3.2 },
    ],
    free_t4: [
      { date: "Aug 24", value: 1.25 },
      { date: "Nov 24", value: 1.28 },
      { date: "Feb 25", value: 1.3 },
      { date: "May 25", value: 1.3 },
      { date: "Nov 25", value: 1.29 },
      { date: "May 26", value: 1.3 },
    ],
    // Metabolic
    fasting_glucose: [
      { date: "Aug 24", value: 95 },
      { date: "Nov 24", value: 93 },
      { date: "Feb 25", value: 91 },
      { date: "May 25", value: 90 },
      { date: "Nov 25", value: 89 },
      { date: "May 26", value: 92 },
    ],
    hba1c: [
      { date: "Aug 24", value: 5.5 },
      { date: "Nov 24", value: 5.45 },
      { date: "Feb 25", value: 5.4 },
      { date: "May 25", value: 5.38 },
      { date: "Nov 25", value: 5.4 },
      { date: "May 26", value: 5.4 },
    ],
    fasting_insulin: [
      { date: "Aug 24", value: 9.5 },
      { date: "Nov 24", value: 9.2 },
      { date: "Feb 25", value: 9.0 },
      { date: "May 25", value: 8.8 },
      { date: "Nov 25", value: 8.6 },
      { date: "May 26", value: 8.5 },
    ...
    homa_ir: [
      { date: "Aug 24", value: 1.4 },
      { date: "Nov 24", value: 1.35 },
      { date: "Feb 25", value: 1.3 },
      { date: "May 25", value: 1.25 },
      { date: "Nov 25", value: 1.22 },
      { date: "May 26", value: 1.2 },
    ],
    // Brain
    cortisol: [
      { date: "Aug 24", value: 15.0 },
      { date: "Nov 24", value: 14.8 },
      { date: "Feb 25", value: 14.5 },
      { date: "May 25", value: 14.3 },
      { date: "Nov 25", value: 14.2 },
      { date: "May 26", value: 14.2 },
    ],
    // Lungs
    spo2: [
      { date: "Aug 24", value: 97 },
      { date: "Nov 24", value: 98 },
      { date: "Feb 25", value: 98 },
      { date: "May 25", value: 97 },
      { date: "Nov 25", value: 98 },
      { date: "May 26", value: 98 },
    ],
    fev1: [
      { date: "Aug 24", value: 3.6 },
      { date: "Nov 24", value: 3.7 },
      { date: "Feb 25", value: 3.75 },
      { date: "May 25", value: 3.8 },
      { date: "Nov 25", value: 3.78 },
      { date: "May 26", value: 3.8 },
    ],
    fvc: [
      { date: "Aug 24", value: 4.6 },
      { date: "Nov 24", value: 4.7 },
      { date: "Feb 25", value: 4.75 },
      { date: "May 25", value: 4.8 },
      { date: "Nov 25", value: 4.78 },
      { date: "May 26", value: 4.8 },
    ],
  };
...
const getSummary = (id: string, status: string): string => {
  const map: Record<string, Record<string, string>> = {
    total_cholesterol: {
      normal:
        "Your cholesterol is well controlled. Keep up your current lifestyle and diet.",
      borderline:
        "Your cholesterol is creeping up. Dietary changes could bring it back down.",
      high: "Your cholesterol is elevated. Speak with your doctor about a management plan.",
    },
    ldl_cholesterol: {
      normal:
        "Your LDL is in a healthy range. A diet rich in fibre can help push it lower.",
    ...
    glucose: {
      optimal:
        "Your blood sugar is well regulated, indicating good insulin sensitivity.",
      normal:
        "Your fasting glucose is healthy. Maintain balanced meals and regular activity.",
      borderline:
        "Your glucose is trending toward prediabetic range. Monitor closely.",
    ...
    creatinine: {
      ...
      normal:
        "Your creatinine is within the healthy range — kidneys are filtering well.",
      borderline:
        "Slightly elevated creatinine. Stay hydrated and monitor at next test.",
    ...
    hemoglobin: {
      ...
      normal:
        "Your hemoglobin is healthy. Maintain iron-rich foods in your diet.",
    ...
    alt: {
      optimal:
        "Your ALT is in an excellent range — your liver is functioning well with no signs of stress.",
      normal:
        "Your ALT is within the healthy range. Your liver is handling its workload well.",
      elevated:
        "Your ALT is mildly elevated. Consider reducing alcohol, processed foods, and reviewing medications.",
      high: "Significantly elevated ALT suggests liver cell damage. Follow up with your doctor promptly.",
    },
    ast: {
      optimal:
        "Your AST is in an ideal range, suggesting healthy liver and muscle tissue.",
      normal:
        "Your AST is within normal limits. No signs of liver or muscle damage.",
      elevated:
        "Mildly elevated AST — could be liver-related or from recent intense exercise.",
      high: "High AST warrants investigation. Consult your doctor to rule out liver or cardiac issues.",
    },
    ggt: {
      optimal:
        "Your GGT is low, indicating minimal liver stress and healthy bile flow.",
      normal: "Your GGT is normal. Your liver is processing bile effectively.",
      elevated:
        "Elevated GGT is often the earliest sign of liver stress. Reduce alcohol and review medications.",
      high: "High GGT suggests significant liver or bile duct stress. Medical review recommended.",
    },
    alp: {
      optimal:
        "Your ALP is in the optimal range — healthy liver drainage and bone metabolism.",
    ...
    total_bilirubin: {
      optimal:
        "Your bilirubin is in the ideal range — efficient liver clearance and healthy red blood cell turnover.",
      normal:
        "Your bilirubin is normal. Your liver is processing waste products effectively.",
      elevated:
        "Mildly elevated bilirubin is often benign (Gilbert's syndrome) but worth monitoring.",
      high: "High bilirubin may cause jaundice. Consult your doctor for further evaluation.",
    },
    // Heart extras
    ldl_c: {
      optimal:
        "Your LDL-C is in the optimal range — excellent cardiovascular protection.",
      normal:
        "Your LDL-C is within a healthy range. Continue heart-healthy habits.",
      borderline:
        "Your LDL-C is borderline. Consider dietary changes to bring it down.",
    ...
    hdl_c: {
      ...
      normal:
        "Your HDL-C is adequate. More exercise and healthy fats can push it higher.",
      low: "Low HDL-C reduces cardiovascular protection. Increase exercise and healthy fats.",
    },
    triglycerides: {
      optimal:
        "Your triglycerides are well controlled — low cardiovascular and metabolic risk.",
      normal:
        "Your triglycerides are in a healthy range. Maintain your current diet and activity.",
      borderline:
        "Triglycerides are trending up. Reduce sugar, refined carbs, and alcohol.",
    ...
    apob: {
      ...
      normal:
        "Your ApoB is in an acceptable range, but lower is better for longevity.",
    ...
    hs_crp: {
      ...
      normal:
        "Your hs-CRP is in a low-risk range. Continue anti-inflammatory habits.",
      borderline:
        "Moderate hs-CRP suggests some systemic inflammation. Review diet, sleep, and stress.",
      high: "High hs-CRP indicates significant inflammation. Investigate underlying causes.",
    },
    homocysteine: {
      optimal:
        "Your homocysteine is in an ideal range — good cardiovascular and neurological protection.",
      normal: "Your homocysteine is within normal limits.",
      elevated:
        "Elevated homocysteine increases vascular risk. Check B12, B6, and folate status.",
      high: "High homocysteine is a significant cardiovascular risk factor. Supplement and retest.",
    },
    // Kidneys
    urea: {
      optimal:
        "Your urea is in the ideal range — kidneys are filtering efficiently.",
    ...
    potassium: {
      optimal:
        "Your potassium is in the ideal range for heart and muscle function.",
    ...
    magnesium: {
      optimal:
        "Your magnesium is in the optimal range — supporting sleep, stress response, and muscle function.",
      normal:
        "Your magnesium is adequate. Most people are borderline deficient, so this is good.",
      low: "Low magnesium is very common and can cause fatigue, cramps, and poor sleep.",
    },
    // Thyroid
    tsh: {
      optimal:
        "Your TSH is in the optimal range — thyroid function looks excellent.",
      normal:
        "Your TSH is normal. Your thyroid is producing adequate hormones.",
    ...
    fasting_glucose: {
      optimal:
        "Your fasting glucose is excellent — strong insulin sensitivity.",
      normal: "Your fasting glucose is in the healthy range.",
      borderline:
        "Your glucose is trending toward prediabetic range. Take preventive action now.",
      high: "Elevated fasting glucose suggests insulin resistance. Medical review recommended.",
    },
    hba1c: {
      optimal:
        "Your HbA1c is excellent — outstanding long-term blood sugar control.",
      normal: "Your HbA1c is in the normal range. Good metabolic health.",
      borderline:
        "Your HbA1c is in the prediabetic range. Lifestyle changes can reverse this.",
      high: "Your HbA1c indicates diabetes. Work with your doctor on a management plan.",
    },
    cortisol: {
      optimal:
        "Your cortisol is in a healthy morning range — balanced stress response.",
...
const getNextTestDue = (id: string): string => {
  const map: Record<string, string> = {
    total_cholesterol: "Nov 2026",
    ldl_cholesterol: "Nov 2026",
    glucose: "Aug 2026",
    creatinine: "Nov 2026",
    hemoglobin: "Oct 2026",
    platelets: "Oct 2026",
    ...
    ggt: "Nov 2026",
    alp: "Nov 2026",
    total_bilirubin: "Nov 2026",
    ldl_c: "Nov 2026",
    hdl_c: "Nov 2026",
    triglycerides: "Nov 2026",
    apob: "Nov 2026",
    hs_crp: "Nov 2026",
    homocysteine: "Nov 2026",
    red_blood_cells: "Oct 2026",
    white_blood_cells: "Oct 2026",
    urea: "Nov 2026",
    sodium: "Nov 2026",
    potassium: "Nov 2026",
    magnesium: "Nov 2026",
    vitamin_d: "Nov 2026",
    vitamin_b12: "Nov 2026",
    folate: "Nov 2026",
    calcium: "Nov 2026",
    ferritin: "Nov 2026",
    transferrin_saturation: "Nov 2026",
    tsh: "Nov 2026",
    free_t3: "Nov 2026",
    free_t4: "Nov 2026",
    fasting_glucose: "Aug 2026",
    hba1c: "Aug 2026",
    fasting_insulin: "Aug 2026",
    homa_ir: "Aug 2026",
    cortisol: "Nov 2026",
    spo2: "Nov 2026",
    fev1: "Nov 2026",
...
const getLastTested = (id: string): string => {
  const map: Record<string, string> = {
    total_cholesterol: "6 May 2026",
    ldl_cholesterol: "6 May 2026",
    glucose: "2 May 2026",
    creatinine: "6 May 2026",
    hemoglobin: "25 Apr 2026",
    platelets: "25 Apr 2026",
    alt: "6 May 2026",
    ast: "6 May 2026",
    ggt: "6 May 2026",
    alp: "6 May 2026",
    total_bilirubin: "6 May 2026",
    ldl_c: "6 May 2026",
    hdl_c: "6 May 2026",
    triglycerides: "6 May 2026",
    apob: "6 May 2026",
    hs_crp: "6 May 2026",
    homocysteine: "6 May 2026",
    red_blood_cells: "25 Apr 2026",
    white_blood_cells: "25 Apr 2026",
    urea: "6 May 2026",
    sodium: "6 May 2026",
    potassium: "6 May 2026",
    magnesium: "6 May 2026",
    vitamin_d: "6 May 2026",
    vitamin_b12: "6 May 2026",
    folate: "6 May 2026",
    calcium: "6 May 2026",
    ferritin: "6 May 2026",
    transferrin_saturation: "6 May 2026",
    tsh: "6 May 2026",
    free_t3: "6 May 2026",
    free_t4: "6 May 2026",
    fasting_glucose: "2 May 2026",
    hba1c: "2 May 2026",
    fasting_insulin: "2 May 2026",
    homa_ir: "2 May 2026",
    cortisol: "6 May 2026",
    spo2: "6 May 2026",
    fev1: "6 May 2026",
...
const SmoothChart: React.FC<{
  ...
  const toY = (v: number) =>
    padT + plotH - ((v - minV) / (maxV - minV)) * plotH;
    ...
    <Svg width={cW} height={cH}>
      ...
      {pts.map((p, i) => (
        <Circle
          ...
          fill={
            selectedIndex === i ? color : i === pts.length - 1 ? color : "#000"
          }
...
const InfoModal: React.FC<{
  ...
  text: string;
  color: string;
}> = ({ visible, onClose, title, text, color }) => (
  <Modal
    visible={visible}
    transparent
    animationType="fade"
...
const LabResultDetailScreen: React.FC = () => {
  ...
  const isHistorical =
    selectedIndex !== null && selectedIndex !== history.length - 1;
  const displayValue = isHistorical
  ...
  const displayDate = isHistorical
    ? expandDate(history[selectedIndex!].date)
    : getLastTested(labResult.id);
  ...
  const displayStatus = isHistorical
    ? getStatusFromValue(displayValue)
    : labResult.status;
  ...
  const pos =
    1 -
    Math.min(
      Math.max((labResult.value - ranges[0].min) / totalRange, 0.02),
      0.98,
    );
  ...
  for (let i = 1; i < ranges.length; i++) {
    ...
    thresholds.push({
      value: val,
      position: p,
      label: `${val < 10 ? val.toFixed(1) : val}`,
    });
  }
    ...
    <View style={st.container}>
      ...
      >
          ...
          <View style={st.heroRow}>
            <View style={{ flexDirection: "row", alignItems: "flex-start" }}>
              ...
              <View style={st.heroMeta}>
                ...
                <Text
                  style={[st.statusText, { color: statusColor, marginTop: 4 }]}
                >
            ...
            <View style={st.heroDates}>
              ...
              {!isHistorical && (
                <Text style={st.heroDateLabel}>
                  Due {getNextTestDue(labResult.id)}
                </Text>
              )}
            </View>
          </View>
        ...
        <View style={{ paddingHorizontal: 24, marginBottom: 36 }}>
          ...
          >
            ...
            {(() => {
              const clampedPos = Math.max(
                0.03,
                Math.min(0.97, (displayValue - ranges[0].min) / totalRange),
              );
              return (
                <View
                  style={{
          ...
          >
            {getSummary(labResult.id, displayStatus)}
          </Text>
        </View>
