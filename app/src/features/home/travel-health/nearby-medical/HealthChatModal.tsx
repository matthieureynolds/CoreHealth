  ...
  const initializeChat = async () => {
    ...
    try {
      ...
      const fallbackMessage: HealthChatMessage = {
        id: 'welcome-fallback',
        role: 'assistant',
        content: "Hello! I'm Toto. How can I help you today? I'm an AI health assistant for educational information and support — not a substitute for professional medical advice. Always consult your doctor for diagnosis or treatment.",
        timestamp: new Date()
      };
