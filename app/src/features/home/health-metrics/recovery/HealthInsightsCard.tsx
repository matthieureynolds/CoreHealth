...
import {
  ...
  ActionsContent,
} from "./components/InsightsTabContent";
...
const HealthInsightsCard: React.FC<HealthInsightsCardProps> = ({
  ...
  const [insights, setInsights] = useState<HealthAssistantResponse | null>(
    null,
  );
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case "recommendations":
        return <RecommendationsContent insights={insights} />;
      case "actions":
        return <ActionsContent insights={insights} />;
      default:
        return <InsightsContent insights={insights} />;
    }
  };
