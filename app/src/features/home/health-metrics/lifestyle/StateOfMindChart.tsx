...
import { StateOfMindChartData } from "@shared/types/symptoms";
        ...
        <View style={styles.chartArea}>
          ...
          <View style={styles.gridLines}>
            {[0, 0.25, 0.5, 0.75, 1].map((position, index) => (
              <View
                key={index}
                style={[styles.gridLine, { top: position * CHART_HEIGHT }]}
              />
            ))}
          </View>
                    ...
                    <View
                      style={[
                        styles.connectingLine,
                        {
                          ...
                          width: Math.sqrt(
                            Math.pow(
                              ((nextPoint.mood - point.mood) / moodRange) *
                                CHART_HEIGHT,
                              2,
                            ) +
      ...
      <View style={styles.summary}>
        <View style={styles.summaryItem}>
          ...
          <Text
            style={[
              styles.summaryValue,
              { color: getMoodColor(data.averageMood) },
            ]}
          >
