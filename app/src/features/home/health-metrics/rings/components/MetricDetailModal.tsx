...
const getMetricDetails = (metric: RingMetric) => {
  switch (metric.id) {
    case "recovery":
      return [
        {
          title: "Sleep Quality (40%)",
          desc: "Sleep duration, consistency, and deep sleep cycles",
          icon: "moon",
          color: "#9013FE",
        },
        {
          title: "Heart Rate Variability (35%)",
          desc: "Autonomic nervous system balance and recovery",
          icon: "heart",
          color: "#FF3B30",
        },
        {
          title: "Rest Periods (25%)",
          desc: "Active recovery and stress management",
          icon: "leaf",
          color: "#30D158",
        },
      ];
    case "biomarkers":
      return [
        {
          title: "Blood Work (40%)",
          desc: "Complete blood count, metabolic panel, and lipids",
          icon: "water",
          color: "#3AABF0",
        },
        {
          title: "Hormone Levels (35%)",
          desc: "Thyroid, cortisol, testosterone, and other hormones",
          icon: "flask",
          color: "#FF9F0A",
        },
        {
          title: "Inflammation Markers (25%)",
          desc: "CRP, ESR, and other inflammatory indicators",
          icon: "thermometer",
          color: "#FF3B30",
        },
      ];
    case "lifestyle":
      return [
        {
          title: "Physical Activity (35%)",
          desc: "Daily steps, exercise frequency, and intensity",
          icon: "fitness",
          color: "#FF6B35",
        },
        {
          title: "Nutrition (30%)",
          desc: "Diet quality, hydration, and meal timing",
          icon: "nutrition",
          color: "#30D158",
        },
        {
          title: "Stress Management (20%)",
          desc: "Mindfulness, relaxation, and work-life balance",
          icon: "leaf",
          color: "#9013FE",
        },
        {
          title: "Sleep Hygiene (15%)",
          desc: "Bedtime routine and sleep environment",
          icon: "moon",
          color: "#3AABF0",
        },
      ];
        ...
        <View style={styles.modalContent}>
          <View style={styles.modalHeader}>
            ...
            <Text style={styles.modalTitle}>
              {getPrettyMetricName(metric)} Score Details
            </Text>
          </View>
          ...
          {metric && (
            ...
            >
              ...
              <View style={styles.scoreDisplay}>
                <View
                  style={[styles.scoreCircle, { borderColor: metric.color }]}
                >
                  <Text
                    style={[styles.modalScoreValue, { color: metric.color }]}
                  >
                    {metric.value}
                  </Text>
