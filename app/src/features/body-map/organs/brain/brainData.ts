...
export const brainOrgan: Organ = {
  id: 'brain',
  label: 'Brain',
  position: { x: 0.5, y: 0.15 }, // Top center of the body
  data: {
    ...
    biomarkers: [
      // Structural Integrity - MRI
      {
        name: 'Brain Age (AI T1)',
        value: 44,
        unit: 'years',
      ...
      {
        name: 'Oxygen Extraction Fraction (OEF)',
        value: 0.42,
        unit: 'ratio',
        range: '0.35-0.50',
        status: 'normal',
      },
      // Molecular Signals - Blood/CSF
      {
      ...
      {
        name: 'Theta Power (4-8 Hz)',
        value: 12.4,
        unit: 'μV²',
        range: '8-18',
        status: 'normal',
      },
      // Sleep & Circadian - EEG/Wearable
      {
      ...
      // Composite Indices - CoreHealth AI
      {
        name: 'Brain Age Gap',
        value: -4,
        unit: 'years',
