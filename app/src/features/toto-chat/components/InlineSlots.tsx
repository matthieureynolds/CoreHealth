...
export const DateTimeCollector: React.FC<DateTimeCollectorProps> = ({
  label,
  onPicked,
}) => {
...
export const SeverityCollector: React.FC<SeverityCollectorProps> = ({
  label = "Severity (0–10)",
  onPicked,
}) => {
...
export const MgCollector: React.FC<MgCollectorProps> = ({
  label = "Dose (mg)",
  step = 100,
  onPicked,
}) => {
