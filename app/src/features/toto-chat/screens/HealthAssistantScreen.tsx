...
import { OPENAI_API_KEY, HealthAssistantService } from '../../../shared/services/healthAssistantService';
import type { ChatSession } from '../../../shared/services/healthAssistantService';
import * as Speech from 'expo-speech';
import * as DocumentPicker from 'expo-document-picker';
import { Audio } from 'expo-av';
import { formatDateBySetting, formatTimeBySetting, formatShortDateBySetting } from '../../../shared/utils/dateFormat';
import { MessageComposer } from '../components/MessageComposer';
import { ChatList, ChatMessage as NewChatMessage } from '../components/ChatList';
...
import type { OrbState } from '../components/TotoOrb';
          ...
          {isLoading && (
            <View style={styles.loadingContainer}>
                <View style={styles.assistantAvatar}>
                  ...
                  {React.createElement(require('../components/TortoAvatar').TortoAvatar, { state: 'thinking', size: 28 })}
                </View>
