...
export const mouthOrgan: Organ = {
  id: 'mouth',
  label: 'Mouth',
  position: { x: 0.65, y: 0.12 }, // Right side of head (opposite to ears)
  data: {
    ...
    biomarkers: [
      ...
      {
        name: 'MMP-8 (Matrix Metalloproteinase-8)',
        value: 18.5,
        unit: 'ng/mL',
        range: '<25',
        status: 'normal',
      ...
      // Additional Oral Health Markers
      {
        name: 'Periodontal Pocket Depth',
        value: 2.1,
        unit: 'mm',
        range: '1-3',
        status: 'normal',
      ...
      {
        name: 'Oral Microbiome Diversity',
        value: 85,
        unit: 'Shannon Index',
        range: '70-100',
        status: 'normal',
      ...
      {
        name: 'Caries Risk Score',
        value: 15,
        unit: 'score',
        range: '0-50 (lower better)',
        status: 'normal',
      },
      {
        name: 'Overall Oral Health Score',
        value: 92,
        unit: 'score',
        range: '80-100',
        status: 'normal',
