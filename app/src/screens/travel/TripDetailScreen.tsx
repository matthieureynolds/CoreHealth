...
import { TravelStackParamList, SerializedTrip } from '../../types';
          ...
          <View style={styles.addonsContainer}>
            ...
            {addonTab === 'vaccinations' ? (
              <View style={styles.checklistBox}>
                <TouchableOpacity style={styles.checklistRow} onPress={() => toggleVax('COVID-19')}>
                  <View style={styles.checklistLeft}>
                    <Ionicons name="shield-checkmark" size={18} color="#34C759" />
                    <Text style={styles.checklistText}>COVID-19</Text>
                  </View>
                  <Ionicons
                    name={vaxChecked['COVID-19'] ? 'checkmark-circle' : 'ellipse-outline'}
                    size={18}
                    color={vaxChecked['COVID-19'] ? '#34C759' : '#8E8E93'}
                  />
                </TouchableOpacity>
                <TouchableOpacity style={styles.checklistRow} onPress={() => toggleVax('Hepatitis A')}>
                  <View style={styles.checklistLeft}>
                    <Ionicons name="shield-checkmark" size={18} color="#FF9F0A" />
                    <Text style={styles.checklistText}>Hepatitis A</Text>
                  </View>
                  <Ionicons
                    name={vaxChecked['Hepatitis A'] ? 'checkmark-circle' : 'ellipse-outline'}
                    size={18}
                    color={vaxChecked['Hepatitis A'] ? '#34C759' : '#8E8E93'}
                  />
                </TouchableOpacity>
              </View>
            ) : (
              <View style={styles.checklistBox}>
                <View style={styles.checklistRow}>
                  <View style={styles.checklistLeft}>
                    ...
                    <Text style={styles.checklistText}>ORS (Oral Rehydration Salts)</Text>
                  </View>
                ...
                <View style={styles.checklistRow}>
                  <View style={styles.checklistLeft}>
                    ...
                    <Text style={styles.checklistText}>Antihistamines</Text>
                  </View>
                  <Ionicons name="ellipse-outline" size={18} color="#8E8E93" />
                </View>
              </View>
