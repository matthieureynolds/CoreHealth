...
export const SettingsScreens = (Stack: StackType) => (
  <>
    ...
    {/* Notifications sub-screens */}
    <Stack.Screen
      name="SupplementsMedicationReminders"
      component={SupplementsMedicationRemindersScreen}
      options={{ headerShown: false }}
    />
    <Stack.Screen
    ...
    />
    <Stack.Screen
      name="MonthlyHealthSummary"
      component={MonthlyHealthSummaryScreen}
      options={{ headerShown: false }}
    />
    <Stack.Screen
      name="WeeklyHealthSummary"
      component={WeeklyHealthSummaryScreen}
      options={{ headerShown: false }}
    />
    <Stack.Screen
      name="SleepReminders"
      component={SleepRemindersScreen}
      options={{ headerShown: false }}
    />
    ...
    />
    <Stack.Screen
      name="HealthDataDownload"
      component={HealthDataDownloadScreen}
      options={{ headerShown: false }}
    />
    <Stack.Screen
      name="DeleteAccount"
