...
export const LegalSupportScreens = (Stack: StackType) => (
  <>
    ...
    <Stack.Screen name="ContactLegalTeam" component={ContactLegalTeamScreen} options={{ headerShown: false }} />
    <Stack.Screen name="RequestData" component={RequestDataScreen} options={{ headerShown: false }} />
  </>
);
