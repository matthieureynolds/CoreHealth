 ...
 */
export async function syncSettingsSnapshot(
...
function assessBiomarkerSignificance(
  biomarker: Biomarker,
...
export async function summarizeConversation(
  ...
  try {
    ...
    if (!response.ok)
      throw new Error(`OpenAI summarize error: ${response.status}`);
