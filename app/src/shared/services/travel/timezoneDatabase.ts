/**
 * Static IANA timezone reference data.
 *
 * 1,000+ lines of table that made timezoneService the largest file in the
 * travel domain and buried the ~200 lines of actual logic inside it.
 */
