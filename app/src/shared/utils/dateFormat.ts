...
export const formatDateBySetting = (
  date: Date,
  pattern: DatePattern,
): string => {
...
export const formatShortDateBySetting = (
  date: Date,
  pattern: DatePattern,
): string => {
  const d = new Date(date);
...
export const formatTimeBySetting = (
  date: Date,
  timeFormat: "12h" | "24h",
): string => {
...
export const formatDateTimeBySettings = (
  date: Date,
  settings: Pick<GeneralSettings, "dateFormat" | "timeFormat">,
): string => {
