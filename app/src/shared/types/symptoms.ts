...
export const PHYSICAL_SYMPTOM_CATEGORIES: SymptomCategory[] = [
  ...
  { id: 'shortness_breath', name: 'Shortness of Breath', type: 'physical', icon: 'airplane-outline', color: '#3AABF0' },
...
export const MENTAL_SYMPTOM_CATEGORIES: SymptomCategory[] = [
  ...
  { id: 'sadness', name: 'Sadness', type: 'mental', icon: 'rainy-outline', color: '#3AABF0' },
