...
const BiomarkerResultCard: React.FC<BiomarkerResultCardProps> = ({ biomarker, backgroundColor }) => (
  <View style={[styles.resultCard, { backgroundColor }]}>
    <View style={styles.resultHeader}>
      ...
      <View style={styles.resultInfo}>
        <Text style={styles.resultRange}>Normal: {biomarker.referenceRange}</Text>
