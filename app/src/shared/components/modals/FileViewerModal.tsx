      ...
      return (
        <View style={styles.errorContainer}>
          ...
          <Text style={styles.errorText}>
            Unable to display this PDF in the viewer. This might be due to file
            format or access restrictions.
          </Text>
    ...
    if (fileUri.startsWith("file://")) {
      return (
        <View style={styles.errorContainer}>
          ...
          <Text style={styles.errorText}>
            This PDF is stored locally on your device. WebView cannot directly
            access local files in Expo Go.
          </Text>
          <Text style={styles.debugText}>URI: {fileUri}</Text>
          <TouchableOpacity
            style={styles.fallbackButton}
        ...
        <View style={styles.content}>
          {detectedFileType === "pdf" ? (
            ...
            <View style={styles.nonPdfContainer}>
              ...
              <Text style={styles.fileDescription}>{getFileDescription()}</Text>
