...
export const vitaminDatabase: {
  ...
  "Vitamin A": {
    ...
    levelMeaning: {
      ...
      normal:
        "Your vitamin A level is healthy, supporting good vision and immune function.",
  ...
  "Vitamin C": {
    ...
    levelMeaning: {
      ...
      normal:
        "Your vitamin C level is healthy, supporting good immune function and skin health.",
  ...
  "Vitamin K": {
    ...
    levelMeaning: {
      ...
      normal:
        "Your vitamin K level is healthy, supporting good blood clotting and bone health.",
  ...
  "Vitamin B12": {
    ...
    levelMeaning: {
      ...
      normal:
        "Your vitamin B12 level is healthy, supporting good red blood cell production and nerve function.",
  ...
  "Vitamin E": {
    ...
    levelMeaning: {
      ...
      normal:
        "Your vitamin E levels are within the healthy range, supporting good immune function and antioxidant protection.",
  ...
  "Vitamin B1 (Thiamine)": {
    ...
    levelMeaning: {
      ...
      normal:
        "Your thiamine levels are within the healthy range, supporting good energy production and nerve function.",
  ...
  "Vitamin B2 (Riboflavin)": {
    ...
    levelMeaning: {
      ...
      normal:
        "Your riboflavin levels are within the healthy range, supporting good energy metabolism and skin health.",
  ...
  "Vitamin B3 (Niacin)": {
    ...
    levelMeaning: {
      ...
      normal:
        "Your niacin levels are within the healthy range, supporting good energy metabolism and heart health.",
  ...
  "Vitamin B5 (Pantothenic Acid)": {
    ...
    levelMeaning: {
      ...
      normal:
        "Your pantothenic acid levels are within the healthy range, supporting good hormone production and energy metabolism.",
  ...
  "Vitamin B6 (Pyridoxine)": {
    ...
    levelMeaning: {
      ...
      normal:
        "Your vitamin B6 levels are within the healthy range, supporting good brain function and protein metabolism.",
  ...
  "Vitamin B7 (Biotin)": {
    ...
    levelMeaning: {
      ...
      normal:
        "Your biotin levels are within the healthy range, supporting healthy hair, skin, and nails.",
  ...
  "Vitamin B9 (Folate)": {
    ...
    levelMeaning: {
      ...
      normal:
        "Your folate levels are within the healthy range, supporting good cell division and red blood cell production.",
