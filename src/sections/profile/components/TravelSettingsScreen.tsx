...
const TravelSettingsScreen: React.FC = () => {
  const { settings, updateTravelSettings } = useSettings();
        ...
        <SettingsItem
          ...
          rightElement={
            <Switch
              ...
              onValueChange={(value: boolean) => updateTravelSettings({ autoLocationDetection: value })}
        ...
        <SettingsItem
          ...
          rightElement={
            <Switch
              ...
              onValueChange={(value: boolean) => updateTravelSettings({ autoEnableTravelHealth: value })}
              trackColor={{ false: '#E5E5EA', true: '#007AFF' }}
              thumbColor="#FFFFFF"
            />
          }
