 ...
 */
const UV_CATEGORIES = {
  0: { category: 'Low', color: '#00FF00', description: 'Minimal sun protection required' },
  1: { category: 'Low', color: '#00FF00', description: 'Minimal sun protection required' },
  2: { category: 'Low', color: '#00FF00', description: 'Minimal sun protection required' },
  3: { category: 'Moderate', color: '#FFFF00', description: 'Some sun protection required' },
  4: { category: 'Moderate', color: '#FFFF00', description: 'Some sun protection required' },
  5: { category: 'Moderate', color: '#FFFF00', description: 'Some sun protection required' },
  6: { category: 'High', color: '#FF8000', description: 'Sun protection essential' },
  7: { category: 'High', color: '#FF8000', description: 'Sun protection essential' },
  8: { category: 'Very High', color: '#FF0000', description: 'Extra sun protection required' },
  9: { category: 'Very High', color: '#FF0000', description: 'Extra sun protection required' },
  10: { category: 'Very High', color: '#FF0000', description: 'Extra sun protection required' },
  11: { category: 'Extreme', color: '#800080', description: 'Avoid sun exposure' },
  12: { category: 'Extreme', color: '#800080', description: 'Avoid sun exposure' },
  13: { category: 'Extreme', color: '#800080', description: 'Avoid sun exposure' },
  14: { category: 'Extreme', color: '#800080', description: 'Avoid sun exposure' },
  15: { category: 'Extreme', color: '#800080', description: 'Avoid sun exposure' }
};

/**
 * Get UV Index recommendations based on category
 */
function getUVRecommendation(category: string, uvIndex: number): string {
  ...
  const categoryRecs = recommendations[category as keyof typeof recommendations] || recommendations['Low'];
 ...
 */
function calculateUVIndex(latitude: number, longitude: number, date: Date): number {
...
export function getUVIndexData(request: UVIndexRequest): UVIndexData {
  ...
  const categoryData = UV_CATEGORIES[uvIndex as keyof typeof UV_CATEGORIES] || UV_CATEGORIES[0];
 ...
 */
export function getCurrentUVIndex(latitude: number, longitude: number): UVIndexData {
 ...
 */
export function getUVProtectionLevel(uvIndex: number): 'minimal' | 'moderate' | 'high' | 'extreme' {
